...
!(function () {
  'use strict';
  var t = { IMG: 0, AUDIO: 1, VIDEO: 2, HTML_WIDGET: 3, TEXT: 4, DIV: 5, SYM: 7, SHAPE: 9, FREEFORM: 11, CUSTOM: 12 },
    e = 1,
    i = 2,
    s = 3,
    n = 0,
    ...
    E = { IMAGE: 0, AUDIO: 1, VIDEO: 2, SYMBOL: 3, FONT: 4, JS: 5, CSS: 6, HTML: 7 },
    D = { NONE: 0, LEFT: 1, RIGHT: 2, HCENTER: 4, JUSTIFY: 8, TOP: 32, BOTTOM: 64, VCENTER: 128 },
    x = 0,
    A = 1,
    C = 2,
    M = 0,
    P = 1,
    R = 3,
    O = ['scripterror', 'sceneactivate', 'scenedeactivate', 'create', 'ready', 'destroy'],
    I = {
      0: 'none',
      1: 'start',
      2: 'progress',
  ...
  (st.transform = !!ot(it.style, 'transform', !0)),
    ...
    (st.cssFilter = rt('filter', 'drop-shadow(5px 5px 5px rgba(0, 0, 0, 0.5))')),
    ...
    (function () {
      if (!window.requestAnimationFrame) {
        for (var t = ['webkit', 'moz', 'ms', 'o'], e = 0, i = t.length; e < i; ++e)
          if (((window.requestAnimationFrame = window[t[e] + 'RequestAnimationFrame']), window.requestAnimationFrame)) {
        ...
        window.requestAnimationFrame ||
          (window.requestAnimationFrame = function (t) {
            var e = Date.now(),
              i = t.requestAnimationFrameTime ? Math.max(0, 16 - (e - t.requestAnimationFrameTime)) : 0;
            return (
    ...
    (st.gradient = (function () {
      ...
      try {
        for (t = 0, e = r.length; t < e; ++t)
          if (((s.backgroundImage = r[t] + n + a[t]), ('' + s.backgroundImage).indexOf('gradient') > -1)) {
            i = { linear: r[t] + n, radial: '-o-' === r[t] ? void 0 : r[t] + 'radial-gradient', prefixed: !!r[t] };
            break;
          }
      } catch (t) {}
      return i;
  ...
  (st.audio = (function () {
    var t,
      ...
      n = /^no$/;
    if (e.canPlayType) {
      for (t in s) s.hasOwnProperty(t) && e.canPlayType(s[t]).replace(n, '') && (i[t] = !0);
    ...
    (st.video = (function () {
      var t,
        ...
        i = {},
        s = { mp4: 'video/mp4;', webm: 'video/webm; codecs="vp8, vorbis"', ogg: 'video/ogg; codecs="theora, vorbis"' },
        n = /^no$/;
      if (e.canPlayType) {
        for (t in s) s.hasOwnProperty(t) && e.canPlayType(s[t]).replace(n, '') && (i[t] = !0);
    ...
    (st.svgShadowBox = ((at = !!Q.documentMode), (ht = !at && !!window.StyleMedia), !at && !ht)),
    (st.filterDropShadow = ((lt = !!Q.documentMode), (ct = !lt && !!window.StyleMedia), !lt && !ct && st.cssFilter));
  ...
  function ft() {
    var t,
      ...
      o = 1,
      r = !0;
    if (('boolean' == typeof (t = arguments[0]) ? ((r = t), (t = arguments[1] || {}), ++o) : t || (t = {}), n <= 1))
      return t;
    for (; o < n; ++o)
      if ((e = arguments[o])) for (i in e) void 0 === (s = e[i]) || (!r && void 0 !== t[i]) || (t[i] = s);
    return t;
  }

  function mt(t, e, i) {
    for (
      var s = t.parentNode, n = i.words ? t.nodeValue.split(/(\s+)/) : t.nodeValue, o = 0, r = n.length;
      o < r;
      ++o
    ) {
      var a,
  ...
  function yt(t, e, i) {
    (t = t || {}), arguments.length < 2 && (e = !0), arguments.length < 3 && (i = !1);
    var s,
      n,
      o,
      r = this.prototype,
      a = {};
    for (s in t) void 0 !== (n = t[s]) && (void 0 === (o = r[s]) ? (r[s] = n) : e && ((a[s] = o), (r[s] = n)));
    var h,
      l,
      c,
      d,
  ...
  function Tt(t) {
    var e;
    Tt.disabled || ((e = t), window.console && console.log(e));
  }
  ...
  function xt(t, e, i, s) {
    return void 0 === e
      ...
      : ((s /= 255), 'rgba(' + Math.round(t) + ',' + Math.round(e) + ',' + Math.round(i) + ',' + s.toFixed(6) + ')');
  }

  function At(t, e) {
    return t.replace('rgb(', 'rgba(').replace(')', ',' + (e / 255).toFixed(6) + ')');
  }
  ...
  function Pt(t, e, i) {
    var s,
      ...
      a = r.length,
      h = !1;
    if (t.classList) for (s = 0; s < a; ++s) i ? t.classList.add(r[s]) : t.classList.remove(r[s]);
    else {
      for (o = (' ' + t.className + ' ').replace(Ct, ' '), s = 0; s < a; ++s)
        if (((n = r[s]), i)) o.indexOf(' ' + n + ' ') < 0 && ((o += n + ' '), (h = !0));
        else for (; o.indexOf(' ' + n + ' ') >= 0; ) (o = o.replace(' ' + n + ' ', ' ')), (h = !0);
  ...
  function Rt(t, e) {
    var i;
    return (
      'auto' === e && 'scroll' === t.style.overflow && ((t.style.overflow = 'hidden'), (i = t.offsetWidth)),
      (t.style.overflow = e),
      i
    );
  }
  ...
  var kt = _t({
    ...
    addObserver: function (t) {
      if (t) {
        var e,
          i,
          s = this.$observable.o;
        for (e = 0, i = s.length; e < i; ++e) if (s[e].o === t && !s[e].removed) return;
        s.push({ o: t });
      }
    },
    ...
    removeObserversById: function (t) {
      var e,
        i = this.$observable.o;
      for (e = i.length - 1; e >= 0; --e)
        i[e].o.id === t && (this.$observable.d > 0 ? (i[e].removed = !0) : i.splice(e, 1));
    },
    removeObservers: function () {
      var t,
        ...
        i = this.$observable,
        s = i.o;
      if (i.d > 0) for (i.removed = !0, t = 0, e = s.length; t < e; ++t) s[t].removed = !0;
      else s.length = 0;
    },
    notifyObservers: function (t, e) {
      if (t) {
        ...
        for (++o.d, i = 0; i < r.length; ++i)
          (s = r[i]).removed || ((s = s.o)[t] && ('$event.handler' === s.id ? (n = s[t](this, e)) : s[t](this, e)));
        if ((--o.d, 0 === o.d))
          if (o.removed) (r.length = 0), (o.removed = !1);
          else for (i = r.length - 1; i >= 0; --i) r[i].removed && r.splice(i, 1);
        return n;
      }
    },
  });
  ...
  function Lt(t, e, i) {
    try {
      return t ? t.call(i.currentTarget, e || fe, i) : void 0;
    } catch (t) {
      if ('scripterror' !== i.type) {
        var s = i.currentTarget || e;
        Kt(s, 'scripterror'), s.notifyObservers('scripterror', { type: i.type, message: t.toString() });
      }
      return void Tt(t);
    }
  }
  ...
  function Bt(t, e, i) {
    if (typeof t === et) return Lt(t, e, i);
    var s;
    if (e)
      switch ((e.transition && Ht(t) && e.transition.goToEnd(), t[0])) {
        case k.TL_ST:
          (s = Nt(e, t[1])) && s.start(t[2] || 1, t[3] || !1);
          break;
        case k.TL_PL:
          (s = Nt(e, t[1])) && s.play(void 0, t[2] || 1, t[3] || !1);
          break;
        case k.TL_PLF:
          (s = Nt(e, t[1])) && s.play(t[2], t[3] || 1, t[4] || !1);
          break;
        case k.TL_PS:
          (s = Nt(e, t[1])) && s.pause();
          break;
        case k.TL_PSA:
          (s = Nt(e, t[1])) && s.pause(t[2]);
          break;
        case k.TL_TGP:
          (s = Nt(e, t[1])) && (s.isPlaying() ? s.pause() : s.play());
          break;
        case k.TL_SK:
          (s = Nt(e, t[1])) && s.seek(t[2]);
          break;
        case k.SYM_ST:
        case k.AV_ST:
          (s = t[0] === k.SYM_ST ? Ft(e, t[1]) : e.getElement(t[1])) &&
            (s.setSpeed && s.setSpeed(t[2] || 1),
            s.setPlayBackward && s.isPlayBackward && s.getDuration
              ? (s.setPlayBackward(t[3] || !1), s.seek && s.seek(s.isPlayBackward() ? s.getDuration() : 0))
              : s.seek && s.seek(0),
            s.play && s.play());
          break;
        case k.SYM_PL:
        case k.AV_PL:
          (s = t[0] === k.SYM_PL ? Ft(e, t[1]) : e.getElement(t[1])) &&
            (s.setSpeed && s.setSpeed(t[2] || 1),
        ...
        case k.SYM_PLF:
        case k.AV_PLF:
          (s = t[0] === k.SYM_PLF ? Ft(e, t[1]) : e.getElement(t[1])) &&
        ...
        case k.SYM_PS:
        case k.AV_PS:
          (s = t[0] === k.SYM_PS ? Ft(e, t[1]) : e.getElement(t[1])) && s.pause && s.pause();
          break;
        case k.SYM_PSA:
        case k.AV_PSA:
          (s = t[0] === k.SYM_PSA ? Ft(e, t[1]) : e.getElement(t[1])) && (s.pause && s.pause(), s.seek && s.seek(t[2]));
          break;
        case k.SYM_TGP:
        case k.AV_TGP:
          (s = t[0] === k.SYM_TGP ? Ft(e, t[1]) : e.getElement(t[1])) &&
            s.pause &&
            s.play &&
            s.isPlaying &&
        ...
        case k.SYM_SK:
        case k.AV_SK:
          (s = t[0] === k.SYM_SK ? Ft(e, t[1]) : e.getElement(t[1])) && s.seek && s.seek(t[2]);
          break;
        case k.AV_MUTE:
        ...
        case k.AV_VOL:
          ...
          break;
        case k.AV_TGMUTE:
          (s = e.getElement(t[1])) && s.setMuted && s.isMuted && s.setMuted(!s.isMuted());
          break;
        case k.AV_MUTE_ALL:
          e.setMuted(!0);
          break;
        ...
        case k.ELEM_HIDE:
          ...
          break;
        case k.ELEM_TGS:
          (s = e.getElement(t[1])) && s.show && s.isVisible && s.show(!s.isVisible());
          break;
        case k.CHANGE_TEXT:
        ...
        case k.JUMP_TO_SCENE:
          var n;
          switch ((void 0 !== t[2] && (n = { transition: [t[2], t[3], t[4], t[5]] }), t[1])) {
            case W.FIRST:
              e.showFirstScene(n);
              break;
            case W.LAST:
        ...
        case k.LINK:
          ...
          break;
        case k.JS:
          return Lt(e.getFunction(t[1]), e, i);
      }
  }
  ...
  var Yt = _t({
      ...
      t && t.type
        ? ((this.domEvent = t),
          ...
          (this.isDefaultPrevented =
            t.defaultPrevented || (void 0 === t.defaultPrevented && !1 === t.returnValue) ? Vt : Wt))
        : (this.type = t),
        e && ft(this, e);
    },
    ...
    stopImmediatePropagation: function () {
      ...
      var t = this.domEvent;
      t && t.stopImmediatePropagation && t.stopImmediatePropagation(), this.stopPropagation();
    },
  });
  ...
  function Gt(t) {
    var e = window.pageXOffset,
      ...
      n = t.clientY;
    return (
      (0 === t.pageY && Math.floor(n) > Math.floor(t.pageY)) || (0 === t.pageX && Math.floor(s) > Math.floor(t.pageX))
        ? ((s -= e), (n -= i))
        : (n < t.pageY - i || s < t.pageX - e) && ((s = t.pageX - e), (n = t.pageY - i)),
      {
        x: s,
        y: n,
      }
  ...
  var Ut,
    ...
    zt = 'mouseup',
    $t = 'mousemove',
    qt = { NONE: 0, LEFT: 1, RIGHT: 2, UP: 4, DOWN: 8, HORIZONTAL: 3, VERTICAL: 12, ALL: 15 };

  function Zt(t, e) {
    return Math.abs(t) >= Math.abs(e) ? (t < 0 ? qt.LEFT : qt.RIGHT) : e < 0 ? qt.UP : qt.DOWN;
  }
  ...
  st.pointer
    ? ((Xt = 'pointerdown'), (zt = 'pointerup'), ($t = 'pointermove'), (Ut = 'pointercancel'))
    : st.touch
    ? ((Xt = 'touchstart'), (zt = 'touchend'), ($t = 'touchmove'), (Ut = 'touchcancel'))
    : st.msPointer && ((Xt = 'MSPointerDown'), (zt = 'MSPointerUp'), ($t = 'MSPointerMove'), (Ut = 'MSPointerCancel'));
  var Qt = {
    swipe: {
      processing: !1,
      minDistance: 30,
      ...
      bind: function (t) {
        ...
        var o = jt(t, 'swipe');
        if ((o == qt.ALL ? (this._swipeDirAll = !0) : (this._swipeDir = (this._swipeDir || 0) | o), n.bind))
          return ++n.bind, null;
        (n.bind = 1),
          (i.start = function (t) {
            if (!(Qt.swipe.processing || (t.touches && t.touches.length > 1))) {
              Qt.swipe.processing = !0;
              var e,
                n = {
                  time: Date.now(),
                  pos: t.targetTouches ? Gt(t.targetTouches[0]) : { x: t.clientX, y: t.clientY },
                },
                o = { time: n.time, pos: n.pos },
                r = s._swipeDirAll || !s._swipeDir ? qt.ALL : s._swipeDir;
              (i.move = function (t) {
                (o = {
                  time: Date.now(),
                  pos: t.targetTouches ? Gt(t.targetTouches[0]) : { x: t.clientX, y: t.clientY },
                }),
                  (e = Zt(o.pos.x - n.pos.x, o.pos.y - n.pos.y)) & r && t.preventDefault();
              }),
                (i.stop = function (t) {
                  i.cancel && i.cancel.call(this, t), (o.time = Date.now());
                  var r = o.pos.x - n.pos.x,
                    a = o.pos.y - n.pos.y;
                  (((e = Zt(r, a)) & qt.HORIZONTAL &&
                    Math.abs(r) > Qt.swipe.minDistance &&
                    Math.abs(a) < Qt.swipe.maxDeflection) ||
                    (e & qt.VERTICAL && Math.abs(a) > Qt.swipe.minDistance && Math.abs(r) < Qt.swipe.maxDeflection)) &&
                    Math.sqrt(r * r + a * a) / (o.time - n.time) > Qt.swipe.minVelocity &&
                    (s.fireEvent('swipe', {
                      direction: e,
                      start: n,
                      stop: o,
                ...
                (i.cancel = function (t) {
                  (Qt.swipe.processing = !1),
                    i.move && Q.removeEventListener($t, i.move, !1),
                    i.stop && Q.removeEventListener(zt, i.stop, !1),
                    Ut && i.cancel && Q.removeEventListener(Ut, i.cancel, !1),
                    (i.move = i.stop = i.cancel = null);
                }),
                Q.addEventListener($t, i.move, !1),
                Q.addEventListener(zt, i.stop, !1),
                Ut && Q.addEventListener(Ut, i.cancel, !1);
            }
          }),
          e.addEventListener(Xt, i.start, !1);
      ...
      unbind: function (t, e) {
        var i = this._domEventTarget('swipe'),
          ...
          n = jt(t, 'swipe');
        if (
          (n == qt.ALL ? (this._swipeDirAll = !1) : this._swipeDir && (this._swipeDir &= ~n),
          (!s.bind || (--s.bind, !s.bind)) && i && i.removeEventListener && e)
        ) {
          e.start && i.removeEventListener(Xt, e.start, !1), (e.start = null), e.cancel && e.cancel.call(i, {});
  ...
  function Jt(t, e, i, s, n) {
    if (
      (i || n) &&
      (typeof e !== tt && (e = I[e]),
      !fe.noHover || ('mouseover' != e && 'mouseout' != e && 'mouseenter' != e && 'mouseleave' != e))
    ) {
      var o,
        r,
      ...
      if (
        (n
          ...
          : a.actions.push({
              action: i,
              status: a.firing > 0 ? 1 : 0,
            }),
        !a.listener)
      )
        Qt[e] && Qt[e].bind && (a.exListener = Qt[e].bind.call(t, e)),
          t._isDomEvent(e) && (o = t._domEventTarget(e)) && o.addEventListener
            ? ((r = function (e) {
                ...
                return (
                  e.target !== e.currentTarget &&
                    t.getDoc &&
                    t.getDoc() &&
                    ((i = t.getDoc().findElementByDom(e.target)) || (i = t.getDoc().findAcrossElementByDom(e.target))),
                  ee(
                    new Yt(e, {
                      target: i || t,
                      currentTarget: t,
            ...
            : (((r = { id: '$event.handler' })[e] = function (t, i) {
                return ee(new Yt(e, { target: t, currentTarget: t, iData: i }));
              }),
              t.addObserver(r)),
          (a.listener = r);
    }
  ...
  function te(t, e) {
    ...
    !s ||
      ...
      s.bubble ||
      !s.listener ||
      (Qt[e] && Qt[e].unbind && Qt[e].unbind.call(t, e, s.exListener),
  ...
  function ee(t, e) {
    ...
    if (a) {
      (i = o.getDoc && o.getDoc()),
        void 0 === e &&
          (o.getScene && o.getScene() && o.getScene().getSceneLayer() === U.ACROSS && (e = i && i.acrossScene),
          void 0 === e && (e = i && i.scene));
      var h,
        l = function (t) {
          return (t ? t.getSceneLayer() : U.MAIN) === U.ACROSS ? t === i.acrossScene : t === i.scene;
        };
      for (
        ++r.firing, s = 0;
        s < a.length &&
        (0 !== (n = a[s]).status ||
          (e && !l(e) && Ht(n.action)) ||
          (!1 === Bt(n.action, i, t) && t.preventDefault(), !t.isImmediatePropagationStopped()));
        ++s
      );
      if (
        (!(h = o._parentEventTarget(t.type)) ||
          ...
          ((t.currentTarget = h), ee(t, e), (t.currentTarget = o)),
        t.isDefaultPrevented() || !r._default || (e && !l(e) && Ht(r._default)) || Bt(r._default, i, t),
        --r.firing,
        0 === r.firing)
      ) {
        for (s = a.length - 1; s >= 0; --s) 2 === a[s].status ? a.splice(s, 1) : (a[s].status = 0);
        a.length || r._default || !r.listener || te(o, t.type);
      }
  ...
  (Qt.swipeleft =
    ...
    Qt.swipedown =
      {
        bind: function (t) {
          return Qt.swipe.bind.call(this, t);
        },
        unbind: function (t, e) {
          Qt.swipe.unbind.call(this, t, e);
        },
      }),
    (Qt.keydown = Qt.keyup =
      {
  ...
  var ie = {
      _getBoundActions: function (t, e) {
        ...
        return !i && e && (i = this.$evtActions[t] = { actions: [], firing: 0, listener: null }), i;
      },
      bind: function (t, e) {
        Jt(this, t, e, !1);
      },
      bindOnce: function (t, e) {
        if (e) {
          var i = function (s, n) {
            return this.unbind(t, i), Bt(e, s, n);
          };
      ...
      unbind: function (t, e) {
        ...
        } else if (this.$evtActions) for (t in this.$evtActions) void 0 !== t && this.unbind(t, e);
      },
      fireEvent: function (t, e) {
        var i, s, n, o, r, a;
        return (
          typeof t !== tt && (t = I[t]),
          this._isDomEvent(t) && (i = this._domEventTarget(t)) && i.dispatchEvent
            ? i.dispatchEvent(
                ((s = t),
                (r = !0),
                (a = !0),
                (n = { iData: e }) &&
                  (void 0 !== n.bubbles && (r = n.bubbles), void 0 !== n.cancelable && (a = n.cancelable)),
                st.customEvent
                  ? (o = new CustomEvent(s, {
                      bubbles: r,
                      cancelable: a,
      ...
      _bindAll: function (t) {
        ...
        if (t)
          for (e = 0, i = t.length; e < i; ++e)
            for (o = (r = t[e])[0], s = 1, n = r.length; s < n; ++s) this.bind(o, r[s]);
      },
    ...
    se = {
      ready: function (t) {
        t ? this.bindOnce('ready', t) : this.isReady && this.notifyObservers('ready');
      },
      bind: function (t, e) {
        typeof t !== tt && (t = I[t]),
          'ready' === t
            ? e && e.$orgHandler
              ? (ie.bind.call(this, t, e), this.isReady && this.notifyObservers(t))
              : this.bindOnce(t, e)
            : ie.bind.call(this, t, e);
      },
    },
    ne = { INITIAL: 0, LOADING: 1, LOADED: 2, ERROR: 3, TIMEOUT: 4 };
  ...
  function oe(t, e, i) {
    return function (s) {
      t(!s),
        ...
        s
          ? s.type === i
            ? ((e.status = ne.LOADED), e.onload && e.onload())
            : ((e.status = ne.ERROR),
              Tt('Error loading ' + e.url + ', event ' + s.type + (e.dom.error ? ', error ' + e.dom.error.code : '')),
              e.onerror && e.onerror())
          : ((e.status = ne.TIMEOUT), Tt('Timeout loading ' + e.url), e.ontimeout && e.ontimeout()),
  ...
  function re(t) {
    var e,
      ...
      s = function (t) {
        t || (i.removeEventListener('load', n, !1), i.removeEventListener('error', n, !1)),
  ...
  function ae(t) {
    var e,
      i,
      s = t.dom || (t.dom = Q.createElement('audio' === t.type ? 'audio' : 'video')),
      n = function (t) {
        t ||
      ...
      o = oe(n, t, 'canplaythrough');
    return (
      s.addEventListener('canplaythrough', o, !1),
      s.addEventListener('error', o, !1),
      t.maxTime ? (e = setTimeout(o, 1e3 * t.maxTime)) : s.addEventListener('stalled', o, !1),
      t.onprogress &&
        ((i = function () {
          if (this.duration) {
            var e,
              i,
              s = 0;
            for (e = 0; e < this.buffered.length; ++e) s += this.buffered.end(e) - this.buffered.start(e);
            (i = s / this.duration) > t.progress &&
              ((t.progress = Math.min(i, 1)), t.onprogress && t.onprogress(t.progress));
          }
        }),
  ...
  function he(t) {
    var e,
      i = t.dom || (t.dom = Q.createElement('css' == t.type ? 'link' : 'script')),
      s = oe(
        function (t) {
          t || (i.removeEventListener('load', s, !1), i.removeEventListener('error', s, !1)),
            e && clearTimeout(e) && (e = null);
        },
        t,
        'load'
    ...
    return (
      ...
      (Q.head || Q.getElementsByTagName('head')[0] || Q.documentElement).insertBefore(i, null),
      t
    );
  }
    ...
    ce = _t(
      kt,
      {
        $init: function (t) {
          ...
          var e = !1;
          (t = this.options).items && ((e = !0), this.add(t.items), delete t.items),
          ...
          if (t) {
            ...
            var e,
              ...
              r = function () {
                ...
                t > -1 && (o.loadingItems.splice(t, 1), ++o.loadedCount, o._update()),
            ...
            for (e = 0, i = t.length; e < i; ++e)
              (s = t[e]) &&
                (((n = {
                  ...
                  progress: 0,
                  status: ne.INITIAL,
                }).type = s.type || ce.getLoadType(n.url)),
                s.id && (n.id = s.id),
                (n.oncomplete = r),
                (n.onprogress = a),
                this.items.push(n));
        ...
        load: function (t) {
          if (
            (this.add(t),
            (this.paused = !1),
            !this.started && ((this.started = !0), this.notifyObservers('start'), this._update(), this.options.maxTime))
          ) {
            var e = this;
          ...
          for (
            ...
            this.items[i].status === ne.INITIAL ? this._loadItem(i) : i === this.nextIdx && ++this.nextIdx;
        },
        pause: function () {
          var t, e;
          if (!this.paused)
            for (this.paused = !0, t = this.loadingItems.length - 1; t >= 0; --t)
              (e = this.loadingItems[t]) &&
                e.cancel() &&
                (this.loadingItems.splice(t, 1),
                e.status === ne.LOADING && ((e.status = ne.INITIAL), (this.nextIdx = 0)));
        },
        clear: function () {
          var t = this.paused;
          this.pause(),
        ...
        holdCompletion: function (t) {
          void 0 === t && (t = !0),
            this.options.holdCompletion !== t && ((this.options.holdCompletion = t), t || this._update());
        },
        _update: function () {
          if (this.started && !this.complete && !this.paused) {
            ...
            if (this.items.length) {
              var e, i;
              for (t = this.loadedCount, e = 0, i = this.loadingItems.length; e < i; ++e)
                t += this.loadingItems[e].progress;
              t /= this.items.length;
            } else t = 1;
            (t === this.progress && 0 !== t) ||
              (this.options.holdCompletion && this.loadedCount === this.items.length) ||
        ...
        _loadItem: function (t) {
          var e = this.items[t];
          if (e) {
            (e.maxTime = this.options.maxItemTime), this.loadingItems.push(e), this.notifyObservers('itemstart', this);
            var i = ce.getTypeLoader(e.type);
            i ? i(e) : ((e.status = ne.ERROR), Tt('Error loading ' + e.url + ', no loader found'), e.oncomplete());
          }
        },
      },
      ie,
  ...
  var ue = new ce(),
    ...
    fe = {
        ...
        if (((i = i || {}), this.unsupportedBrowser)) {
          if (!i.isPreloader) {
            var s,
              n = (function (t, e, i) {
                var s, n;
                for (s = 0; s < 2 && (!e || (e[i] && (n = e[i][t]), !n && e._default && (n = e._default[t]), !n)); ++s)
                  e = fe.messages;
                return n || '';
              })('unsupportedBrowser');
            typeof e === tt && ((s = e), (e = Q.getElementById(s))),
              e
                ...
                : s &&
                  fe.ready(function () {
                    (e = Q.getElementById(s)) && fe.showMessage(n, e);
                  });
          }
          return null;
        }
      ...
      findDoc: function (t, e) {
        ...
        if ((typeof t === tt && ((o = t), (t = Q.getElementById(o))), !o && !t)) return null;
        for (i = 0, s = r.length; i < s; ++i)
          if (((n = r[i]), (o && n.containerId === o) || (t && n.container === t))) return n;
        return null;
      },
      tick: function (t) {
        for (var e = 0, i = this.topDocs.length; e < i; ++e) this.topDocs[e].tick(t);
      },
      setAnimationTime: function (t) {
        ge.setTime(t);
      },
      clearAnimationTime: function () {
        ge.clearTime(), ge.start();
      },
    };

  function me() {
    Q.removeEventListener('DOMContentLoaded', me, !1),
      window.removeEventListener('load', me, !1),
      fe.isReady || ((fe.isReady = !0), fe.ready());
  }

  ft(fe, new kt(), ie, se, {
    bind: function (t, e) {
      var i, s;
      if ((se.bind.call(this, t, e), typeof t !== tt && (t = I[t]), 'createdocument' === t))
    ...
    window.AtomiSaola && (fe.AtomiSaolaOld = window.AtomiSaola),
    (window.AtomiSaola = fe),
    window.addEventListener(
      'resize',
      function () {
        var t, e;
        for (t = 0, e = fe.topDocs.length; t < e; ++t) fe.topDocs[t].layoutIfNeeded();
      },
      !1
    ),
    'complete' === Q.readyState
      ...
      : (Q.addEventListener('DOMContentLoaded', me, !1), window.addEventListener('load', me, !1));
  var ge = {
      FPS: 60,
      INTERVAL: 16,
      time: 0,
      ...
      stop: function () {
        (this.ticking = !1), this.timerId && (cancelAnimationFrame(this.timerId), (this.timerId = null));
      },
      now: function () {
        var t = this.syncTimes;
        return (
          this.ticking || ((this.time = void 0 !== this.exTime ? this.exTime : Date.now()), (t.length = 0)),
      ...
      requestNext: function () {
        void 0 === this.exTime && (this.timerId = requestAnimationFrame(ye));
      },
      setTime: function (t) {
        (this.exTime = t), ye();
      },
  ...
  function ye() {
    var t, e;
    if ((ge.now(), (ge.ticking = !0), ge.requestNext(), fe.tick(ge.time), pe.length && ge.time - ve > 500))
      for (ve = ge.time, t = 0, e = pe.length; t < e; ++t) li(pe[t]);
    ge.ticking = !1;
  }
  ...
  var _e = {
      ...
      outInQuad: function (t) {
        return t < 0.5 ? _e.outQuad(2 * t) / 2 : 1 - _e.outQuad(2 - 2 * t) / 2;
      },
      inCubic: function (t) {
        return t * t * t;
      },
      ...
      outInCubic: function (t) {
        return t < 0.5 ? _e.outCubic(2 * t) / 2 : 1 - _e.outCubic(2 - 2 * t) / 2;
      },
      inQuart: function (t) {
        return t * t * t * t;
      },
      ...
      outInQuart: function (t) {
        return t < 0.5 ? _e.outQuart(2 * t) / 2 : 1 - _e.outQuart(2 - 2 * t) / 2;
      },
      inQuint: function (t) {
        return t * t * t * t * t;
      },
      ...
      outInQuint: function (t) {
        return t < 0.5 ? _e.outQuint(2 * t) / 2 : 1 - _e.outQuint(2 - 2 * t) / 2;
      },
      inSine: function (t) {
      ...
      outInSine: function (t) {
        return t < 0.5 ? _e.outSine(2 * t) / 2 : 1 - _e.outSine(2 - 2 * t) / 2;
      },
      inExpo: function (t) {
      ...
      outInExpo: function (t) {
        return t < 0.5 ? _e.outExpo(2 * t) / 2 : 1 - _e.outExpo(2 - 2 * t) / 2;
      },
      inCirc: function (t) {
      ...
      outInCirc: function (t) {
        return t < 0.5 ? _e.outCirc(2 * t) / 2 : 1 - _e.outCirc(2 - 2 * t) / 2;
      },
      inElastic: function (t) {
        return 0 === t || 1 === t ? t : -Math.pow(2, 8 * (t - 1)) * Math.sin(((80 * (t - 1) - 7.5) * j) / 15);
      },
      outElastic: function (t) {
        return 1 - _e.inElastic(1 - t);
      },
      inOutElastic: function (t) {
        return t < 0.5 ? _e.inElastic(2 * t) / 2 : 1 - _e.inElastic(2 - 2 * t) / 2;
      },
      outInElastic: function (t) {
        return t < 0.5 ? _e.outElastic(2 * t) / 2 : 1 - _e.outElastic(2 - 2 * t) / 2;
      },
      inBack: function (t) {
      ...
      outInBack: function (t) {
        return t < 0.5 ? _e.outBack(2 * t) / 2 : 1 - _e.outBack(2 - 2 * t) / 2;
      },
      inBounce: function (t) {
      ...
      outBounce: function (t) {
        return 1 - _e.inBounce(1 - t);
      },
      inOutBounce: function (t) {
        return t < 0.5 ? _e.inBounce(2 * t) / 2 : 1 - _e.inBounce(2 - 2 * t) / 2;
      },
      outInBounce: function (t) {
        return t < 0.5 ? _e.outBounce(2 * t) / 2 : 1 - _e.outBounce(2 - 2 * t) / 2;
      },
    },
    Te = {
      '-1': 'instant',
  ...
  _e._default = _e.inOutQuad;
  var we = _t({
      $init: function (t) {
        (this.t = t[0]), (this.d = t[2] || 0), (this.actions = t[1] || []), (this.fired = !1);
      },
      ...
      fire: function (t) {
        if (!this.fired) {
          ...
          for (e = 0, i = s.length; e < i; ++e) (o && o !== n.scene && Ht(s[e])) || Bt(s[e], n, r);
        }
      },
    }),
    Se = _t({
      $init: function (t, e, i) {
        (this.tween = Se.createTween(t, e, i)), (this.t = e.t), (this.d = e.d), this.setEasing(e.es);
      },
      setup: function () {
      ...
      setEasing: function (t) {
        this.easing = typeof t === et ? t : _e[Te[t]] || _e[t] || _e._default;
      },
      getStartTime: function () {
        return this.t;
      },
    ...
    be = _t(Se, {
      $init: function (t, e, i) {
        Se.prototype.$init.call(this, t, e, i), (this.timeline = null), (this.isPlayback = !0);
        var s = this;
        this.timelineObs = {
          play: function (t) {
            s.isCurrent(t.ts, t.isPlayBackward(), !1) && s.tween.update(t.ts - s.t, t, Me.Flags.PLAYING);
          },
          pause: function (t) {
            s.isCurrent(t.ts, t.isPlayBackward(), !1) && s.tween.update(t.ts - s.t, t, Me.Flags.PLAYING);
          },
          speedchange: function (t) {
            s.isCurrent(t.ts, t.isPlayBackward(), !1) && s.tween.update(t.ts - s.t, t, Me.Flags.SPEED);
          },
        };
      },
      setup: function (t) {
        (this.timeline = t),
          Se.prototype.setup.call(this, t),
          this.isCurrent(t.ts, t.isPlayBackward(), !0) &&
            (this.tween.update(t.ts - this.t, t, Me.Flags.ALL),
            (t.isPlayBackward() ? t.ts <= this.t + this.d : t.ts >= this.t) && (this.complete = !0));
      },
      reverse: function (t) {
        (this.timeline = t),
          Se.prototype.reverse.call(this, t),
          this.isCurrent(t.ts, t.isPlayBackward(), !1) && this.tween.update(t.ts - this.t, t, Me.Flags.DIRECTION);
      },
      update: function (t, e) {
        this.timeline &&
          this.isCurrent(this.timeline.ts, this.timeline.isPlayBackward(), !0) &&
          this.timeline.ts === (this.timeline.isPlayBackward() ? this.t + this.d : this.t) &&
          (this.tween.update(this.timeline.ts - this.t, this.timeline, Me.Flags.ACTION), (this.complete = !0));
      },
      isCurrent: function (t, e, i) {
        if (t < this.t) {
          if (this.prev) return e && i && (this.complete = !0), !1;
        } else if (this.next && t >= this.next.t) return !e && i && (this.complete = !0), !1;
        return !0;
      },
    }),
    Ee = /[a-zA-Z%]+$/;
  ...
  function De(t) {
    ...
    return (
      typeof t === tt
        ? ((e.value = parseFloat(t)), (e.unit = t.match(Ee)), e.unit && (e.unit = e.unit[0]))
        : (e.value = t),
      e
    );
  }
  ...
  var xe = _t({
      $init: function (t, e, i) {
        ...
        (this.u = e.u),
        void 0 === e.u && 'ts' != t) &&
          (typeof e.s == tt && ((s = De(e.s)), isNaN(s.value) || ((this.s = s.value), (this.u = s.unit))),
          typeof e.e == tt && ((s = De(e.e)), isNaN(s.value) || ((this.e = s.value), (this.u = s.unit))));
        St(this.s) && St(this.e) && (this.delta = this.e - this.s);
      },
      update: function (t) {
        void 0 !== this.delta
  ...
  (Se.regTweenType = function (t) {
    for (var e = arguments.length; --e > 0; ) Ae[arguments[e]] = t;
  }),
    (Se.createTween = function (t) {
      return (Ae[je.getShortName(t)] || Ae._default).apply(null, arguments);
    });
  var Ce = _t(xe, {
    update: function (t) {
      this.elem.setProperty(this.p, t < 1 ? this.s : this.e, this.u);
  ...
  var Me = _t(xe, {
    $init: function (t, e, i) {
      xe.prototype.$init.call(this, t, e, i), (this.action = e.a[0]), (this.s = e.a[1]), (this.speed = e.a[2] || 1);
    },
      ...
      switch (this.action) {
        ...
        case F:
          ...
          i & Me.Flags.PLAYING &&
            ...
            this.elem.pause(),
            i & Me.Flags.SPEED && this.elem.setSpeed(Math.abs(e.getSpeed() * this.speed)),
            i & Me.Flags.DIRECTION &&
              this.elem.setPlayBackward &&
              this.elem.setPlayBackward(this.speed < 0 !== e.isPlayBackward()),
            (i & Me.Flags.TIME || (i & Me.Flags.TIMEACTION && (this.action !== N || 0 !== t))) &&
              this.elem.seek(this.s + this.speed * t),
            i & Me.Flags.PLAYING && !s && ((this.elem.isEnded && this.elem.isEnded()) || this.elem.play());
          break;
        case B:
        case H:
          i & Me.Flags.PLAYING && this.elem.pause(),
            (i & Me.Flags.TIME || (this.action === H && i & Me.Flags.TIMEACTION)) && this.elem.seek(this.s);
      }
    },
  });
  (Me.Flags = {
    ...
    Se.regTweenType(function (t, e, i) {
      return new Me(t, e, i);
    }, 'pb');
  var Pe = _t(xe, {
    $init: function (t, e, i) {
      if ((xe.prototype.$init.call(this, t, e, i), pt(this.s) && pt(this.e))) {
        var s,
          n = this.s[3],
          o = this.e[3];
        for (
          void 0 === n && (n = 255), void 0 === o && (o = 255), this._s = [], this._e = [], this.delta = [], s = 0;
          s < 3;
          ++s
        )
          (this._s[s] = this.s[s] * n), (this._e[s] = this.e[s] * o), (this.delta[s] = this._e[s] - this._s[s]);
    ...
    update: function (t) {
      if (void 0 !== this.delta) {
        var e,
          i,
          s = [],
          n = wt(this._s[3] + this.delta[3] * t, 0, 255);
        for (e = 0; e < 3; ++e) (i = this._s[e] + this.delta[e] * t), (s[e] = i ? wt(i / n, 0, 255) : i);
  ...
  function Re(t, e, i) {
    var s = i * i,
      ...
      h = 3 * r * i,
      l = 3 * o * s;
    return { x: a * t[0] + h * t[4] + l * e[2] + n * e[0], y: a * t[1] + h * t[5] + l * e[3] + n * e[1] };
  }
  ...
  function Oe(t, e, i, s, n) {
    ...
    return (
      (Ie(a, {
        ...
        Ie(h, l) > 4 * n) &&
        ((a.t = o + r), i.splice(s + 1, 0, a), (c = 1 + Oe(t, e, i, s + 1, n)), (c += Oe(t, e, i, s, n))),
      c
    );
  }
  ...
  var ke = _t(xe, {
    $init: function (t, e, i) {
      xe.prototype.$init.call(this, t, e, i),
        (this.cpoints = e.cp || []),
    ...
    update: function (t) {
      if (this.cpoints.length < 2) {
        ...
        je.set(this.elem, { tX: pt(e) ? e[0] : e, tY: pt(e) ? e[1] : e, rZM: '' });
      } else {
        var i = this.getT(t),
          s = Math.floor(i),
          n = this.cpoints,
          o = n.length - 2;
        s < 0 ? ((s = 0), (i = 0)) : (s > o && (s = o), (i -= s) > 1 && (i = 1));
        var r,
          a,
          h,
          l,
        ...
        g < 1e-6 ? (g = 1e-6) : g > 0.999999 && (g = 0.999999),
          ...
          (u = (d = g) * d),
          (a = {
            x: 3 * (f = (p = 1 - d) * p) * (l[4] - l[0]) + 6 * p * d * (c[2] - l[4]) + 3 * u * (c[0] - c[2]),
            y: 3 * f * (l[5] - l[1]) + 6 * p * d * (c[3] - l[5]) + 3 * u * (c[1] - c[3]),
          }),
          (t < 0 || t > 1) &&
            (r = Math.sqrt(a.x * a.x + a.y * a.y)) > 0 &&
            ((h = t > 1 ? t - 1 : t), (m.x += (h * this.pathLen * a.x) / r), (m.y += (h * this.pathLen * a.y) / r)),
          this.autoOrient && ((v = (180 * Math.atan2(a.y, a.x)) / j), this.autoOrient < 0 && (v += 180)),
          je.set(this.elem, {
            tX: m.x,
            tY: m.y,
            rZM: v,
    ...
    createPath: function () {
      ...
      var t,
        ...
        o = n.length - 1,
        r = this.path;
      for (t = 0; t < o; ++t) for (e = 0; e < 4; ++e) (i = e / 4), ((s = Re(n[t], n[t + 1], i)).t = t + i), r.push(s);
      for (o >= 0 && (((s = Re(n[o - 1] || n[o], n[o], 1)).t = o), r.push(s)), t = o - 1; t >= 0; --t)
        for (e = 3; e >= 0; --e) Oe(n[t], n[t + 1], r, 4 * t + e, 2);
    },
    calcLen: function () {
      ...
      var t,
        ...
        i = 0,
        s = e.length - 1;
      for (t = 0; t < s; ++t) (e[t].l = i), (i += Ie(e[t], e[t + 1]));
      s >= 0 && (e[s].l = i), (this.pathLen = i), (this.lenTimes = []);
      var n,
        o,
        r = this.lenTimes,
        a = i,
        h = this.getDuration() > 0 ? (a * ge.INTERVAL) / this.getDuration() : a;
      if (((this.stepLen = h), h > 0))
        for (t = 0, i = 0; t < s; )
          if (e[t + 1].l < i) ++t;
            ...
            r.push({
              l: i,
              t: o.l > n.l ? n.t + ((i - n.l) * (o.t - n.t)) / (o.l - n.l) : n.t,
            }),
            (i += h) > a)
          )
            break;
    ...
    getT: function (t) {
      ...
      return (
        0 == a
          ...
          : 1 == a
          ? (e = r[0].t)
          : ((s = r[(i = this.stepLen > 0 ? Math.min(Math.max(0, Math.floor(o / this.stepLen)), a - 2) : 0)]),
            (e = (n = r[i + 1]).l > s.l ? s.t + ((o - s.l) * (n.t - s.t)) / (n.l - s.l) : s.t)),
        e
      );
    },
  });
  ...
  var Le = _t(xe, {
    $init: function (t, e, i) {
      ...
      (this.sW = n[1]),
        ...
        (n = this.s = n[0]),
        (o = this.e = o[0]),
        typeof n != tt && (s.clear(), xi(s, n), (n = s.getPath())),
        typeof o != tt && (s.clear(), xi(s, o), (o = s.getPath())),
    ...
    update: function (t) {
      var e,
        i = this.sW,
        s = this.sH;
      0 == t ? (e = this.s) : 1 == t ? ((e = this.e), (i = this.eW), (s = this.eH)) : (e = this._morph(t)),
  ...
  var Fe = _t(xe, {
    $init: function (t, e, i) {
      var s, n, o, r;
      if (
        (xe.prototype.$init.call(this, t, e, i), (o = this.s = Ne(e.s)), (r = this.e = Ne(e.e)), o.length != r.length)
      ) {
        for (n = Math.max(o.length, r.length); o.length < n; ) o.push(0);
        for (; r.length < n; ) r.push(0);
      }
      for (this.delta = [], s = 0, n = o.length; s < n; ++s) this.delta[s] = r[s] - o[s];
    },
    update: function (t) {
      var e,
        i,
        s = [];
      for (e = 0, i = this.delta.length; e < i; ++e) s.push(Math.max(this.s[e] + this.delta[e] * t, 0));
  ...
  var Be = _t({
      ...
      update: function (t, e) {
        ...
        for (i = 0; i < o.length; ++i)
          if (!(n = o[i]).complete) {
            ...
            } else if (t > n.t + n.d && (e ? (s = !0) : (n.complete = !0), n.next && t >= n.next.t)) continue;
            if (s) {
      ...
      _calcDur: function () {
        var t,
          ...
          s = this.anims,
          n = 0;
        for (e = 0, i = s.length; e < i; ++e) n < (t = s[e].getEndTime()) && (n = t);
        return n;
      },
      getEndTime: function () {
        return this.t + this.d;
    ...
    He = _t(Be, {
      ...
      update: function (t, e) {
        ...
        for (i = d.length - 1; i >= 0; --i)
          if (((r = (s = d[i]).complete), t < s.t)) e && (s.complete = !0), (!o || o.t > s.t) && ((o = s), (h = r));
          else {
            if (t <= (c = s.t + s.d)) break;
            e || (s.complete = !0), (!n || l < c) && ((n = s), (l = c), (a = r));
          }
        i < 0 &&
          ((s = null), n ? (e && n.preCompl) || ((s = n), (r = a)) : o && ((!e && o.preCompl) || ((s = o), (r = h)))),
  ...
  function We(t, e, i) {
    ...
    var n = 0,
      o = 0;
    return (
      (i.textAnimEnabled && !i.textAnimEnabled()) || ((n = s.ta) && (o = n | i._DEF.taf | Ve(t))),
      {
        startTime: s.t,
        endTime: s.t + s.d,
        background: s.ao,
        ...
        textDelayEasing: _e[Te[s.de]],
        textSplit: { chars: Z.CHARS & o, words: Z.WORDS & o, processStyles: 'backgroundColor, textDecoration' },
      }
    );
  }
  ...
  var Ye = 'cl c d o tp b lt rt toX toY toZ pos tX tY tZ rX rY rZ rZM skX skY sX sY sZ fz tc ls'.split(' ');

  function Ge(t, e, i) {
    return i && (i.chars || i.words) && t.splitText && Ye.indexOf(e) >= 0 && t.getText();
  }
  ...
  function Ue(t, e, i, s, n) {
    ...
    return (
      i &&
        (o = i.length) > 0 &&
        (o > 1 || Ge(t, e, n)
          ? (((r = new Be()).elem = t), (r.prop = e), ze(r, t, e, i, s, n), r.trim())
          : (r = $e.createAnimation(e, i[0], t))),
      r && void 0 !== s && (r.effectId = s),
      r
    );
  }

  function Xe(t, e, i, s, n, o, r) {
    var a = $e.createAnimation(i, s, e);
    a && (e != o && o && (a.ownerElem = o), void 0 !== n && (a.effectId = n), r && (a.ownerProp = r), t.add(a));
  }
  ...
  function ze(t, e, i, s, n, o) {
    ...
    if (f) {
      var m = e.splitTexts;
      (!m || (o.chars && !m.chars) || (o.words && !m.words)) && (e.splitText(o.textSplit), (m = e.splitTexts)),
        o.background && (e.hasFill() || e.hasLine()) ? (p.push(e.painter), (u = o.firstTextDelay)) : p.push(null),
        m && (o.chars && m.chars ? (p = p.concat(m.chars)) : o.words && m.words && (p = p.concat(m.words)));
    } else p.push(e);
    if (((d = s.length), (a = p.length), d && a)) {
      ...
      if (a > 1) {
        var _ = (function (t, e, i, s) {
          ...
          for (e *= t - 1, o = 0; o < t; ++o)
            (n = l ? h[o] / l : 0), a && (n = 1 - n), (h[o] = Math.round((s ? s(n) : n) * e));
          return (
            i == q.RAND &&
              h.sort(function () {
      ...
      for (r = 0; r < a; ++r) {
        var w = p[r];
        if (w) for (g = y[r], c = 0; c < d; ++c) (l = (h = s[c]).t), (h.t += g), Xe(t, w, i, h, n, e), (h.t = l);
        else {
          if (0 != r) continue;
          if (
            ((w = e.painter),
            ...
            var S = h.cp,
              ...
              E = S[1].slice(),
              D = b.slice();
            (E[4] = E[2]), (E[5] = E[3]), (D[2] = D[4]), (D[3] = D[5]), (h.cp = [b, E, D]), h.ao && (h.ao *= -1);
          }
          Xe(t, w, i, h, n, e);
        }
        f && Xe(t, w, i, T, n, e);
      ...
      if (f) {
        if ((m && !m.processEffects) || !m.processEffects[n]) {
          m.processEffects || (m.processEffects = {}), (m.processEffects[n] = i);
          var x = m.listItems;
          if (x)
            for (r = 0; r < x.length; ++r) {
              var A = x[r].dom.style.listStyleType || '';
              Xe(
                t,
                x[r],
                'listStyleType',
                ...
                Xe(t, x[r], 'listStyleType', { t: v, d: 0, s: 'none', e: A }, n, e, i);
            }
          if (m.processStyles)
            for (var C in m.processStyles) {
              var M = m.processStyles[C];
              if (M && M.length) {
                var P = 'backgroundColor' == C ? 'textHighlightColor' : C;
                for (r = 1; r < a; ++r)
                  for (c = M.length - 1; c >= 0; --c)
                    if (M[c].dom.contains(p[r].dom)) {
                      var R = M[c].dom.style[C];
                      Xe(t, p[r], P, { t: o.startTime, d: 0, s: '', e: R }, n, e, i);
                      break;
                    }
                for (r = 0; r < M.length; ++r)
                  (R = M[r].dom.style[C]),
                    ...
                    Xe(t, M[r], P, { t: v, d: 0, s: '', e: R }, n, e, i);
              }
            }
        }
        for (
      ...
      kt.prototype,
      {
        $init: function (t, e) {
          ...
          var i,
            s,
            n = t.t || [];
          for (i = 0, s = n.length; i < s; ++i) this.events.push(new we(n[i]));
        ...
        add: function (t) {
          Be.prototype.add.call(this, t),
            t.isPlayback &&
              ((t.timingEvent = new we([t.getStartTime(), [], t.getDuration()])),
        ...
        _recreateAnims: function () {
          ...
          for (e = 0, i = c.length; e < i; ++e)
            (n = (t = c[e]).anims ? t.elem : t.ownerElem || t.tween.elem) &&
              ...
              t.isPlayback &&
                ((s = this.events.indexOf(t.timingEvent)) >= 0 && this.events.splice(s, 1),
                this.removeObserver(t.timelineObs));
          for (c.length = 0, e = 0, i = (c = this._getAnimData()).length; e < i; ++e)
        ...
        _hasTextAnim: function (t) {
          var e,
            ...
            s,
            n = this._getAnimData();
          for (e = 0, i = n.length; e < i; ++e) if (((s = n[e]), this.getElement(s[0]) == t)) return 0 != Ve(s[2]);
          return !1;
        },
        _recreateTextAnims: function (t) {
          var e,
            ...
            d = !1;
          for (e = 0, i = c.length; e < i; ++e)
            if (((o = c[e]), (r = this.getElement(o[0])), (l = Ve((h = o[2]))), r && l && (!t || t(r))))
              for (d = !0, this._removePropAnims(r), s = 0, n = (o = o[1]).length; s < n; ++s)
                (a = o[s]), this._addPropAnims(r, a[0], a[1], a[2], h);
          if (d && (this.updateDuration(), void 0 !== this.t)) {
            var u = this.complete;
            this.seek(nt && window.canvas && this.paused ? window.canvas.currentTime : this.ts), (this.complete = u);
          }
        },
        _addPropAnims: function (t, e, i, s, n) {
          var o, r;
          if (((e = je.getShortName(e)), s && s.length && (1 != s.length || (i && i.length)))) {
            var a,
              h,
              l,
              c = new He();
            for (
              c.elem = t, c.prop = e, i && i.length && (a = Ue(t, e, i)) && c.add(a), h = 0, l = s.length;
              h < l;
              ++h
            )
              (r = s[h][0]), (a = Ue(t, e, s[h][1], r, We(n, r, t))) && c.add(a);
            c.trim(), this.add(c);
          } else s && 1 == s.length ? ((r = s[0][0]), (o = s[0][1])) : (o = i), o && ze(this, t, e, o, r, We(n, r, t));
        },
        _removePropAnims: function (t, e) {
          ...
          for (s = r.length - 1; s >= 0; --s)
            if (
              ((i = r[s]).anims
                ? ((n = i.elem), (o = i.prop))
                : ((n = i.ownerElem || i.tween.elem), (o = i.ownerProp || i.tween.p)),
              n == t && (e == o || void 0 === e))
            ) {
              if ((r.splice(s, 1), t.splitTexts && t.splitTexts.processEffects)) {
                var h = t.splitTexts;
                if (void 0 === e) delete h.processEffects;
                else for (var l in h.processEffects) h.processEffects[l] == e && delete h.processEffects[l];
              }
              if ((!a && i.getEndTime() >= this.d && (a = !0), i.isPlayback && this.events)) {
                var c = this.events.indexOf(i.timingEvent);
                c >= 0 && this.events.splice(c, 1), this.removeObserver(i.timelineObs);
              }
            }
        ...
        _calcDur: function () {
          var t,
            ...
            i,
            s,
            n = Be.prototype._calcDur.call(this);
          for (i = 0, s = this.events.length; i < s; ++i) n < (e = (t = this.events[i]).t + t.d) && (n = e);
          for (i in this.labels) (e = this.labels[i]), !isNaN(e) && n < e && (n = e);
          return n;
        },
        start: function (t, e) {
          var i = e;
          void 0 === i && (i = this.speed < 0), this.play(i ? this.getDuration() : 0, t, e);
        },
        play: function (t, e, i) {
          var s = this.doc.scene;
          void 0 !== e && this.setSpeed(e), void 0 !== i && this.setPlayBackward(i);
          var n = !1;
          this.paused && ((this.paused = !1), (n = !0), this.notifyObservers('play')),
            typeof t === tt && (t = this.labels[t]),
            void 0 === t
              ? n &&
                (void 0 === this.t
                  ? this.seek(this.speed < 0 ? this.d : 0)
                  : ((this.t = ge.now() - this.ts / (this.doc.getEffectiveSpeed() * this.speed)), this.update(this.ts)))
              : this.seek(t),
        ...
        seek: function (t) {
          if (typeof t !== tt || void 0 !== (t = this.labels[t])) {
            var e,
              i,
              s = (t = wt(t, 0, this.d)) !== this.ts || void 0 === this.t,
              n = this.ts;
            if (
              ((this.ts = t),
              (this.t = ge.now() - this.ts / (this.doc.getEffectiveSpeed() * this.speed)),
              (this.complete = !1),
              s)
            ) {
              var o = this.events;
        ...
        setSpeed: function (t) {
          ...
          t > 0 && t !== e && (this.doSetSpeed(this.speed < 0 ? -t : t), this.notifyObservers('speedchange', e));
        },
        doSetSpeed: function (t) {
          if (0 !== t && t !== this.speed)
            if (
              (this.paused || (this.t = ge.now() - this.ts / (this.doc.getEffectiveSpeed() * t)), this.speed * t < 0)
            ) {
        ...
        setPlayBackward: function (t) {
          void 0 === t && (t = !0),
            !t != this.speed > 0 && (this.doSetSpeed(-this.speed), this.notifyObservers('reverse'));
        },
        ...
        update: function (t) {
          var e,
            ...
            l = this.doc.scene,
            c = !1;
          if (((t = wt(t, 0, this.d)), !this.paused))
            for (i = 0; i < o; ++i)
              if (((e = n[r ? o - 1 - i : i]), (s = r ? e.t + e.d : e.t), !e.fired && (r ? s >= t : s <= t))) {
                if (
                  ((a = !0),
                  (this.ts = s),
                  Be.prototype.update.call(this, this.ts, this.speed < 0),
                  ge.pushSync(this.t + this.ts / (this.doc.getEffectiveSpeed() * this.speed)),
                  e.fire(this),
                  ge.popSync(),
          ...
          (a && (this.ts == t || c)) || ((this.ts = t), Be.prototype.update.call(this, this.ts, this.speed < 0)),
            this.notifyObservers('update', h);
        },
        tick: function (t) {
          if (!this.paused) {
            var e = this.doc.scene;
            this.update((t - this.t) * this.doc.getEffectiveSpeed() * this.speed),
        ...
        addTimingEvent: function (t) {
          var e,
            ...
            s = t.getStartTime(),
            n = this.events;
          for (e = 0, i = n.length; e < i; ++e) if (n[e].getStartTime() > s) return void n.splice(e, 0, t);
          n.push(t);
        },
        _checkComplete: function () {
          if ((this.speed < 0 ? this.ts <= 0 : this.ts >= this.d) && !this.paused) {
            this.complete = !0;
            var t = this.doc.scene;
            this.pause(), this.complete && this.doc.scene === t && this.notifyObservers('complete');
          }
        },
  ...
  ($e.regAnimType = function (t) {
    for (var e = arguments.length; --e > 0; ) qe[arguments[e]] = t;
  }),
    $e.regAnimType(function (t, e, i) {
      return new be(t, e, i);
    }, 'pb'),
    ($e.createAnimation = function (t) {
      return (qe[je.getShortName(t)] || qe._default).apply(null, arguments);
    });
  var Ze = {
      bottom: 'b',
      className: 'cl',
    ...
    je = {
      ...
      set: function (t, e, i) {
        var s, n, o, r, a;
        if ('object' == typeof e) for (s in e) e.hasOwnProperty(s) && this.set(t, s, e[s]);
        else if (((s = this.props[e]) || ((a = Ze[e]), (s = this.props[a]) && (e = a)), s))
          s.c && t._props[e] !== i && (t._props[e] = i.slice ? i.slice() : i),
            s.s
              ...
              ? ((o = this.props[s.p]),
                ...
                (r[o.c.indexOf(e)] = i),
                ge.ticking && t.getTimelineScene && t.getTimelineScene()
                  ? t.getTimelineScene()._delayUpdate(s.p + t.domId, function () {
                      je.set(t, s.p, r);
                    })
                  : je.set(t, s.p, r))
              : (s.n && (e = s.n),
                ...
                'a' === s.a
                  ? n.setAttribute(e, i)
                  : ('p' !== s.a && ((n = n.style), s.b && (e = K[e] || (K[e] = ot(n, e)))),
      ...
      prepare: function (t, e) {
        ...
        if (t.c)
          if (pt(e)) {
            for (s = 0, n = t.c.length, i = ''; s < n; ++s) i += this.prepare(this.props[t.c[s]], e[s]) + ' ';
            i = i.trim();
          } else i = e;
        else {
          if (void 0 === (i = e)) {
          ...
          t.d && (i /= t.d), t.u && St(i) && (i += t.u), t.f && (i = t.f.replace('{1}', i));
        }
        return i;
      },
      ...
      props: {
        ...
        tf: {
          n: 'transform',
          b: 1,
          c: ['tX', 'tY', 'tZ', 'rX', 'rY', 'rZ', 'rZM', 'skX', 'skY', 'sX', 'sY', 'sZ'],
          o: 'childrenContainer',
        },
        ...
        t: {
          ...
          s: function (t, e) {
            ...
            (s && s.length) || (s = ''),
              ...
              (i = e[0]) && (i[0] && (s[3] = i[0]), i[1] && (s[4] = i[1]), i[2] && (s[5] = i[2])),
              (i = e[2]) && (i[0] && (s[7] = i[0]), i[1] && (s[8] = i[1])),
              (i = e[1]) &&
                (100 !== i[0] && (s[9] = i[0]), 100 !== i[1] && (s[10] = i[1]), 100 != i[2] && (s[11] = i[2])),
              (i = e[3]) && (i[0] && (s[0] = i[0]), i[1] && (s[1] = i[1]), i[2] && (s[2] = i[2])),
              je.set(t, 'tf', s);
          },
        },
        s: {
        ...
        lc: {
          s: function (t, e) {
            typeof e === tt ? t.setBorderColor(e) : t.setBorderColor(e[0], e[1], e[2], e[3]);
          },
        },
        da: {
          s: function (t, e) {
          ...
          s: function (t, e) {
            switch (e[0]) {
              case l:
                ...
                break;
              case c:
                e[1] == y ? t.fillRadialGradient(e[2], e[3], e[4], e[5], e[6]) : t.fillLinearGradient(e[2], e[3]);
                break;
              case d:
                var i = e[1];
                typeof i != tt && (i = (t.getDoc && t.getDoc().getResource(i)) || ''), t.fillImage(i, e[2], e[3], e[4]);
                break;
              default:
                t.fillNone();
            }
        ...
        fc: {
          s: function (t, e) {
            typeof e === tt ? t.fillSolid(e) : t.fillSolid(e[0], e[1], e[2], e[3]);
          },
        },
        ga: {
          s: function (t, e) {
        ...
        tc: {
          s: function (t, e) {
            (t.textDom || t.dom).style.color = typeof e === tt ? e : xt(e[0], e[1], e[2], e[3]);
          },
        },
        thc: {
          s: function (t, e) {
        ...
        underline: {
          s: function (t, e) {
            Ot(t.textDom || t.dom, 'underline', e);
          },
        },
        strikeThrough: {
          s: function (t, e) {
            Ot(t.textDom || t.dom, 'line-through', e);
          },
        },
        ...
        txt: {
          ...
          s: function (t, e) {
            var i = '';
            e[7] ? (i = e[8] ? 'underline line-through' : 'underline') : e[8] && (i = 'line-through'),
              t.setText(e[0] || ''),
              je.set(t, {
                ff: e[1],
                fz: e[2],
        ...
        sh: {
          v: [],
          s: function (t, e) {
            (e = e || []).length > 0 ? t.applyShadow(e[0], e[1], e[2], e[3], e[4], e[5], e[6]) : t.clearShadow();
          },
        },
        shr: {
          s: function (t, e) {
        ...
        shc: {
          s: function (t, e) {
            typeof e === tt ? t.setShadowColor(e) : t.setShadowColor(e[0], e[1], e[2], e[3]);
          },
        },
        fif: {
          s: function (t, e) {
        ...
        pso: {
          ...
          s: function (t, e) {
            if (t.setPerspective) {
              ...
              e[3] && t.scene && !t.scene.transformStyle && (i = 0), t.setPerspective(e[0], e[1], i);
            }
          },
        },
        listStyleType: {},
  ...
  var Ke = _t({
      ...
      hasClass: function (t) {
        ...
        return e.classList
          ...
          : (' ' + e.className + ' ').replace(Ct, ' ').indexOf(' ' + t + ' ') > -1;
      },
      toggleClass: function (t) {
        ...
        if (!(n < 1))
          if (i.classList) for (e = 0; e < n; ++e) i.classList.toggle(s[e]);
            ...
            var o = (' ' + i.className + ' ').replace(Ct, ' ');
            for (e = 0; e < n; ++e) {
              var r = s[e];
              if (o.indexOf(' ' + r + ' ') < 0) o += r + ' ';
              else for (; o.indexOf(' ' + r + ' ') >= 0; ) o = o.replace(' ' + r + ' ', ' ');
              i.className = o.trim();
            }
          }
      },
      show: function (t) {
        this.dom.style.visibility = (void 0 !== t && '' !== t && !t) || 'none' == t || 'hidden' == t ? 'hidden' : '';
      },
      ...
      setLeft: function (t) {
        ...
        (e.left = St(t) ? t + 'px' : t), (e.right = 'auto');
      },
      setRight: function (t) {
        var e = this.dom.style;
        (e.right = St(t) ? t + 'px' : t), (e.left = 'auto');
      },
      setTop: function (t) {
        var e = this.dom.style;
        (e.top = St(t) ? t + 'px' : t), (e.bottom = 'auto');
      },
      setBottom: function (t) {
        var e = this.dom.style;
        (e.bottom = St(t) ? t + 'px' : t), (e.top = 'auto');
      },
      setSize: function (t, e) {
        var i = this.dom.style;
        (i.width = St(t) ? t + 'px' : t), (i.height = St(e) ? e + 'px' : e);
      },
      setWidth: function (t) {
        this.dom.style.width = St(t) ? t + 'px' : t;
      },
      setHeight: function (t) {
        this.dom.style.height = St(t) ? t + 'px' : t;
      },
      hasLine: function () {
      ...
      setBorderWidth: function (t) {
        this.dom.style.borderWidth = St(t) ? t + 'px' : t;
      },
      setBorderColor: function (t, e, i, s) {
        this.dom.style.borderColor = xt(t, e, i, s);
      },
      fillNone: function () {
        this.fillType = h;
      ...
      fillSolid: function (t, e, i, s) {
        ...
        (n.backgroundColor = xt(t, e, i, s)), (n.backgroundImage = 'none');
      },
      fillImage: function (t, e, i, s) {
        if (
          ((this.fillType = d),
          this._imageFillData
            ? ((this._imageFillData[1] = e), (this._imageFillData[2] = i), (this._imageFillData[3] = s))
        ...
        (this.dom.style.backgroundImage = 'url("' + t.replace(/"/g, '\\"') + '")'),
          ...
          e === u
            ...
            : e === p && ((this.dom.style.backgroundSize = 'auto'), (this.dom.style.backgroundPosition = 'center')),
      ...
      fillLinearGradient: function (t, e) {
        if (((this.fillType = c), st.gradient.linear)) {
          var i,
            ...
            r = !e,
            a = [],
            h = st.gradient.linear + '(' + (st.gradient.prefixed ? 90 - t : t) + 'deg';
          if (r) {
            if (!this._gradient || this._gradient[0] != v) return;
            e = this._gradient[1];
          } else this._gradient = [v];
          for (i = 0, s = e.length; i < s; ++i)
            (n = e[i]), r || a.push(n.slice()), (h += ', ' + xt(n[1], n[2], n[3], n[4]) + ' ' + n[0] + '%');
          (h += ')'), r || this._gradient.push(a), (o.backgroundImage = h), (o.backgroundColor = 'transparent');
        } else if (e && e[0]) {
          var l = e[0];
      ...
      fillRadialGradient: function (t, e, i, s, n) {
        if (((this.fillType = c), st.gradient.radial && !st.gradient.prefixed)) {
          var o,
            r,
            a,
            h,
          ...
          for (p += ' ' + h + ' at ' + t + '% ' + e + '%', o = 0, r = i.length; o < r; ++o)
            (a = i[o]), d || u.push(a.slice()), (p += ', ' + xt(a[1], a[2], a[3], a[4]) + ' ' + a[0] + '%');
          (p += ')'),
            d || (this._gradient.push(u), this._gradient.push(s), this._gradient.push(n)),
            (l.backgroundImage = p),
            l.backgroundImage.toLowerCase().indexOf(h) < 0 &&
              ((l.backgroundImage = p.replace(t + '%', t + 1 + '%')), (l.backgroundImage = p)),
      ...
      setShadowBlurRadius: function (t) {
        ...
        this.applyShadow(De(t).value, e, i, s, n);
      },
      setShadowAngle: function (t) {
        var e = void 0 === this._shadowRadius ? 5 : this._shadowRadius,
          ...
          s = void 0 === this._shadowColor ? 'rgb(0, 0, 0)' : this._shadowColor,
          n = void 0 === this._shadowAlpha ? 128 : this._shadowAlpha;
        this.applyShadow(e, De(t).value, i, s, n);
      },
      setShadowDistance: function (t) {
        var e = void 0 === this._shadowRadius ? 5 : this._shadowRadius,
          ...
          s = void 0 === this._shadowColor ? 'rgb(0, 0, 0)' : this._shadowColor,
          n = void 0 === this._shadowAlpha ? 128 : this._shadowAlpha;
        this.applyShadow(e, i, De(t).value, s, n);
      },
      ...
      clearShadow: function () {
        if (void 0 !== this._shadowRadius)
          if (
            ...
            ut && this._fixSafariShadow && (delete this._fixSafariShadow, (this.dom.style.willChange = ''));
            var t = this.dom.style[K.filter];
            -1 != t.indexOf('drop-shadow') &&
              (this.dom.style[K.filter] = t.replace(/\s*drop-shadow\(([^()]*|\([^()]*\))*\)/, '').trim());
          } else this._obShadow();
      },
      _obShadow: function () {
      ...
      _obBgShadow: function (t, e, i, s, n) {
        ...
        void 0 !== t &&
          (o =
            i * Math.cos((e / 180) * j) + 'px ' + i * Math.sin((e / 180) * j) + 'px ' + 4 * t + 'px 0px ' + At(s, n));
        this.dom.style.boxShadow = o;
      },
      _obTextShadow: function (t, e, i, s, n) {
        var o = '';
        void 0 !== t &&
          (o = i * Math.cos((e / 180) * j) + 'px ' + i * Math.sin((e / 180) * j) + 'px ' + t + 'px ' + At(s, n));
      ...
      applyShadow: function (t, e, i, s, n, o, r) {
        if (void 0 !== t) {
          ...
          (this._shadowRadius = t),
            ...
            typeof s === tt
              ? ((this._shadowColor = s), (this._shadowAlpha = n), (a = At(this._shadowColor, this._shadowAlpha)))
              : ((a = xt(s, n, o, r)), (this._shadowColor = xt(s, n, o)), (this._shadowAlpha = r));
          var h,
            l = i * Math.cos((e / 180) * j),
            c = i * Math.sin((e / 180) * j);
          if (dt) {
            ut && !this._fixSafariShadow && ((this._fixSafariShadow = !0), (this.dom.style.willChange = K.filter));
      ...
      setTextHighlightColor: function (t) {
        this.dom.style.backgroundColor = typeof t === tt ? t : xt(t[0], t[1], t[2], t[3]);
      },
    }),
    ti = Ke,
    ei = _t(
      ...
      kt.prototype,
      {
        $init: function (t, e) {
          ...
          (i.id = this.domId),
            (s.position = 'absolute'),
            Ke.prototype.$init.call(this, i),
            this.painter || (this.painter = new Ke(this.dom));
          var n,
            o,
            r,
            a,
            h = t.elems || [];
          for (n = 0, o = h.length; n < o; ++n) (a = h[n]), (r = ii.createElem(a.k, a, e)), this.addChild(r);
          var l = je.setAnyProp;
          (je.setAnyProp = !1),
            je.set(this, t),
            (je.setAnyProp = l),
        ...
        _onDetached: function () {
          ...
          for (
            s &&
              ...
              this.tick && (i = s.dynElems.indexOf(this)) > -1 && s.dynElems.splice(i, 1)),
              t = 0,
              e = this.elems.length;
            t < e;
            ++t
        ...
        _onRemoved: function (t) {
          var e,
            ...
            s,
            n = this.scene;
          for (e = 0, i = this.elems.length; e < i; ++e) this.elems[e]._onRemoved(t);
          (this.dom.style.backgroundImage = 'none'),
            this._onRemovedFromDoc && this._onRemovedFromDoc(),
            n &&
              t &&
              (n.mapIdElems[this.id] === this && delete n.mapIdElems[this.id],
              n.mapNameElems[this.name] === this && delete n.mapNameElems[this.name],
              n.mapDomIdElems[this.domId] === this && delete n.mapDomIdElems[this.domId],
              this.tick && (s = n.dynElems.indexOf(this)) > -1 && n.dynElems.splice(s, 1),
              (this.scene = null));
        },
        remove: function () {
          var t,
          ...
          if ((this._onRemoved(this !== this.scene), this.parent)) {
            ...
            i > -1 && (this.parent.elems.splice(i, 1), e && !this.parent.elems.length && (t = this.parent.dom)),
              (this.parent = null);
          }
          this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), t && (t.style[K.transformStyle] = '');
        },
        getScene: function () {
          return this.scene;
        },
        ...
        show: function (t) {
          (t = Qe(t)),
            ...
            'none' != t ? this._checkIfResized() : (this._w && (this._w = 0), this._h && (this._h = 0));
        },
        isVisible: function () {
          return this.dom.offsetWidth > 0 || this.dom.offsetHeight > 0;
        },
        setOverflow: function (t) {
          (t = Je(t)), this._setOverflow4Container(t), this._setOverflow4Text(t);
        },
        _updatePointerEvents: function () {
          ...
          this.dom == this.painter.dom
            ...
            : ((t.pointerEvents = i ? 'auto' : 'none'), (this.painter.dom.style.pointerEvents = s ? 'auto' : 'none'));
        },
        _setOverflow4Container: function (t) {
          this.textContainer
            ? ((this.dom.style.overflow = ''), this._updatePointerEvents())
            : (Rt(this.dom, t), this._updatePointerEvents());
        },
        _setOverflow4Text: function (t) {
          this.textContainer
            ? (Rt(this.textContainer, t),
              (this.textContainer.style.pointerEvents = 'auto' == t || 'scroll' == t ? 'auto' : ''),
          ...
          if (this.textDom) {
            ...
            switch (t) {
              ...
              case D.BOTTOM:
                ...
                break;
              default:
                (e.top = '50%'), (e.bottom = 'auto'), (e[i] = 'translateY(-50%)');
            }
          } else
        ...
        setTextHighlightColor: function (t) {
          this.textDom
            ? (this.textDom.style.backgroundColor = typeof t === tt ? t : xt(t[0], t[1], t[2], t[3]))
        ...
        setPosition: function (t, e) {
          var i = this.dom.style;
          (i.left = St(t) ? t + 'px' : t), (i.top = St(e) ? e + 'px' : e), (i.right = 'auto'), (i.bottom = 'auto');
        },
        setAutoWidth: function (t) {
          return (
            ...
            t &&
              ((this._autoH = !1),
              (this._aspectRatio = (this.dom.clientWidth || this._w) / (this.dom.clientHeight || this._h) || 0)),
            this
          );
        },
        ...
        setSize: function (t, e) {
          var i = this.dom.style;
          (i.width = St(t) ? t + 'px' : t),
            (i.height = St(e) ? e + 'px' : e),
            (this._autoW = this._autoH = !1),
            this._checkIfResized();
        },
        setWidth: function (t) {
          (this.dom.style.width = St(t) ? t + 'px' : t), (this._autoW = !1), this._checkIfResized();
        },
        setHeight: function (t) {
          (this.dom.style.height = St(t) ? t + 'px' : t), (this._autoH = !1), this._checkIfResized();
        },
        ...
        fillRadialGradient: function (t, e, i, s, n) {
          var o = this.hasFill();
          this.painter.fillRadialGradient(t, e, i, s, n), !o && this._fillLineChanged();
        },
        ...
        setClipShape: function (t) {
          ...
          if (st.clipPath)
            if (
              ...
              switch (((this._props.wc = t), t[0])) {
                case V:
                  e = 'inset(';
                  for (var s = 1; s < 5; ++s) (e += (i = De(t[s])).unit ? t[s] : i.value + 'px'), 4 != s && (e += ' ');
                  (e += ')'), (this.dom.style[K.clipPath] = e);
                  break;
                case G:
                  (e = 'ellipse('),
                    (e += ((i = De(t[1])).unit ? t[1] : i.value + 'px') + ' '),
                    (e += (i = De(t[2])).unit ? t[2] : i.value + 'px'),
                    (e += ' at 50% 50%)'),
          ...
          else if (pt(t) && 5 == t.length && t[0] == V) {
            if (t[0] === V) {
              this._props.wc = t;
              var n = getComputedStyle(this.dom, null),
                o = De(n.width).value,
                r = De(n.height).value,
                a = De(n.borderTopWidth).value || 0;
              (o += 2 * a),
                (r += 2 * a),
                '%' === (i = De(t[1])).unit && (i.value = (r * i.value) / 100),
                (e = 'rect(' + i.value + 'px, '),
                '%' === (i = De(t[2])).unit ? (i.value = o - (o * i.value) / 100) : (i.value = o - i.value),
                (e += i.value + 'px, '),
                '%' === (i = De(t[3])).unit ? (i.value = r - (r * i.value) / 100) : (i.value = r - i.value),
                (e += i.value + 'px, '),
                '%' === (i = De(t[4])).unit && (i.value = (o * i.value) / 100),
                (e += i.value + 'px)'),
        ...
        _updateClipRectIfNeed: function () {
          ...
          t && t[0] === V && !st.clipPath && this.setClipShape(this._props.wc);
        },
        setClipRectTop: function (t) {
          var e = this._props.wc;
          5 != this._props.wc.length && (e = [V, 0, 0, 0, 0]), (e[1] = t), this.setClipShape(e);
        },
        setClipRectRight: function (t) {
          var e = this._props.wc;
          5 != this._props.wc.length && (e = [V, 0, 0, 0, 0]), (e[2] = t), this.setClipShape(e);
        },
        setClipRectBottom: function (t) {
          var e = this._props.wc;
          5 != this._props.wc.length && (e = [V, 0, 0, 0, 0]), (e[3] = t), this.setClipShape(e);
        },
        setClipRectLeft: function (t) {
          var e = this._props.wc;
          5 != this._props.wc.length && (e = [V, 0, 0, 0, 0]), (e[4] = t), this.setClipShape(e);
        },
        ...
        setClipCircleRadius: function (t) {
          var e = this._props.wc;
          2 != this._props.wc.length && st.clipPath && (e = [Y, 0]), (e[1] = t), this.setClipShape(e);
        },
        _obShadow: function () {
          void 0 === this._shadowRadius || (!this.hasFill() && !this.hasLine() && this.textContainer)
        ...
        setFilter: function () {
          ...
          var t,
            ...
            n,
            o = '',
            r = 'invert hue-rotate contrast brightness saturate sepia grayscale blur'.split(' '),
            a = '% deg % % % % % px'.split(' ');
          if (3 === arguments.length) {
            ...
            for (
              i = arguments[2],
                ...
                this._filter[h] = void 0 === i || typeof i == tt ? i : i + a[r.indexOf(h)],
                s = 0,
                n = r.length;
              s < n;
              ++s
            )
              void 0 !== (e = this._filter[r[s]]) && (o += r[s] + '(' + e + ') ');
          } else if (2 === arguments.length)
            for (t = this[(t = arguments[0])] || this.dom, i = arguments[1], s = 0, n = r.length; s < n; ++s)
              void 0 !== (e = i[s]) && typeof e != tt && (e += a[s]),
                (this._filter[r[s]] = e),
                void 0 !== e && (o += r[s] + '(' + e + ') ');
          if (dt && void 0 !== this._shadowRadius) {
            var l = this._shadowDistance * Math.cos((this._shadowAngle / 180) * j),
              c = this._shadowDistance * Math.sin((this._shadowAngle / 180) * j),
              d = this._shadowColor;
            (d = d.replace('rgb(', 'rgba(').replace(')', ',' + this._shadowAlpha / 255 + ')')),
              (o = 'drop-shadow(' + l + 'px ' + c + 'px ' + this._shadowRadius + 'px ' + d + ') ' + o);
          }
        ...
        setText: function (t) {
          var e;
          if (
            ((t += ''), this.textDom || (!t && !nt) || this._initText(), this.textDom) &&
            ((it.innerHTML = t),
            (this.splitTexts ? this.splitTexts._unsplitText : this.textDom.innerHTML) != it.innerHTML &&
              (this.splitTexts && (this.unsplitText(), (e = !0)), (this.textDom.innerHTML = t), e))
          ) {
            var i = this.getDoc(),
          ...
          if (this.textDom) {
            ...
            for (var c = 0; c < 2; ++c) {
              ...
              for (n = 0; n < h.length; ++n)
                if ((o = a[(s = h[n])])) for (e = 0, i = o.length; e < i; ++e) o[e] = new ti(o[e]);
            }
          }
        },
        unsplitText: function () {
          if (this.textDom && this.splitTexts && void 0 !== this.splitTexts._unsplitText) {
            (this.textDom.innerHTML = this.splitTexts._unsplitText), delete this.splitTexts;
            var t = this.painter.dom.style;
            (t[K.transform] = ''), (t.opacity = ''), (t.display = ''), (t.left = 0), (t.top = 0);
          }
        },
        ...
        _onResized: function (t, e) {
          (this._autoH || this._autoW) &&
            (this._aspectRatio
              ? this._autoH
                ? t && (this.setHeight(this.dom.clientWidth / this._aspectRatio), (this._autoH = !0))
                : e && (this.setWidth(this._aspectRatio * this.dom.clientHeight), (this._autoW = !0))
              : (this._aspectRatio = this.dom.clientWidth / this.dom.clientHeight || 0));
        },
        ...
        _normLayoutProps: function () {
          ...
          if (r && !r.normed) {
            for (e = 0, i = r.length; e < i; ++e) {
              if (((n = (s = r[e])[2]), 0 == s[0] && 0 == s[1] && ((o = n), 1 == i))) return void (r.normed = !0);
              for (t in n) a[t] = 1;
            }
            for (o || ((o = {}), r.push([0, 0, o])), e = 0, i = r.length; e < i; ++e) {
              n = r[e][2];
              for (t in a)
                t in n ||
  ...
  gt(ei.prototype, 'painter', ['setBorderWidth', 'setBorderColor']);
  var ii = _t(ei, {
      $init: function (t, e) {
        (this.id = 0),
          (this.sceneId = t.id),
          ...
          ei.prototype.$init.call(this, t, this),
          ...
          r = {
            getElement: function (t) {
              ...
              return (
                ...
                s.sceneLayer != i && (s = i == U.MAIN ? e.scene : e.acrossScene),
        ...
        for (i = 0, s = n.length; i < s; ++i) this.timelines.push(new $e(n[i], r));
      ...
      create: function () {
        var t = ei.prototype.create.call(this);
        if (nt || this._DEF.t3d) {
          (this.transformStyle = 'preserve-3d'), (this.childrenContainer = Q.createElement('div'));
      ...
      setSize: function (t, e) {
        var i = this.dom.style,
          ...
          n = De(t),
          o = De(e);
        '%' === n.unit ? ((s.width = t), (i.width = '100%')) : (s.width = i.width = n.unit ? t : t + 'px'),
          '%' === o.unit ? ((s.height = e), (i.height = '100%')) : (s.height = i.height = o.unit ? e : e + 'px'),
          this.doc.options.autofit && this.doc.fit(),
          this._checkIfResized();
      },
      setWidth: function (t) {
        var e = this.dom.style,
          i = De(t);
        '%' === i.unit ? (e.width = '100%') : (i.unit || (t += 'px'), (e.width = t)),
          this.doc._setWidth(t),
          this._checkIfResized();
      },
      setHeight: function (t) {
        var e = this.dom.style,
          i = De(t);
        '%' === i.unit ? (e.height = '100%') : (i.unit || (t += 'px'), (e.height = t)),
          this.doc._setHeight(t),
          this._checkIfResized();
      },
      _delayUpdate: function (t, e) {
        this._delayUpdates || (this._delayUpdates = {}), (this._delayUpdates[t] = e);
      },
      _parentEventTarget: function () {
        return this.doc;
      },
      onLayoutSwitched: function () {
        ei.prototype.onLayoutSwitched.call(this);
      },
      ...
      setPerspective: function (t, e, i) {
        (t = De(t).value), (e = De(e).value), (i = De(i).value), (this.perspective = { x: t, y: e, z: i });
        var s = this.dom.style;
        (s[K.perspectiveOrigin] = this.perspective.x + '% ' + this.perspective.y + '%'),
          (s[K.perspective] = this.perspective.z ? this.perspective.z + 'px' : 'none');
      },
    }),
    si = {
  ...
  (ii.regElemType = function (t) {
    for (var e = arguments.length; --e > 0; ) si[arguments[e]] = t;
  }),
    (ii.createElem = function (t) {
      var e = si[t] || si._default;
  ...
  var ni = _t({
    $init: function (t, e, i) {
      ...
      if (
        ...
        var n = this._createAnims(i[1], i[2]),
          o = {
            dom: s.dom,
            setProperty: ei.prototype.setProperty,
            setWidth: function (t) {
              s._setWidth(St(t) ? t + 'px' : t);
            },
            setHeight: function (t) {
              s._setHeight(St(t) ? t + 'px' : t);
            },
          };
        this.timeline = new $e(
    ...
    goToEnd: function () {
      if (this.doc) {
        var t = this.timeline;
        t.complete || ((this.playScene = t.isPlaying()), t.play(t.isPlayBackward() ? 0 : t.getDuration()));
      }
    },
    _onSceneChanged: function () {
      ...
      this.timeline.isPlayBackward()
        ...
        t &&
          (Kt(t, 'scenedeactivate'),
          t.notifyObservers('scenedeactivate', {
            scene: t,
            newScene: e,
          })),
        ...
        e &&
          (Kt(e, 'sceneactivate'),
          e.notifyObservers('sceneactivate', {
            scene: e,
            oldScene: t,
          }));
    },
    ...
    _onComplete: function () {
      ...
      this.doc.transition === this && (this.doc.transition = null),
        ...
        this.timeline.isPlayBackward()
          ...
          : ((t = this.oldScene), (e = this.newScene), (i = this.newSceneProps)),
        t && t.remove(),
        e &&
          (e.setProperty(i),
  ...
  (ii.regTransType = function (t) {
    for (var e = arguments.length; --e > 0; ) oi[arguments[e]] = t;
  }),
    (ii.createTransition = function (t) {
    ...
    _onStart: function () {
      ...
      this.newScene
        ? ((r = this.newScene.dom.style),
          ...
          this.oldScene
            ? ((a = this.oldScene.dom.style), (e = this.oldScene.dom.offsetWidth), (n = this.oldScene.dom.offsetHeight))
            : ((e = t), (n = s)))
        ...
        t !== e &&
          ((i = Math.max(e, t)),
          (l.width = i + 'px'),
          r && ((r.width = t + 'px'), this.doc.options.center & D.HCENTER && (r.left = (i - t) / 2 + 'px')),
          a && ((a.width = e + 'px'), this.doc.options.center & D.HCENTER && (a.left = (i - e) / 2 + 'px'))),
        s !== n &&
          ((o = Math.max(n, s)),
          (l.height = o + 'px'),
          r && ((r.height = s + 'px'), this.doc.options.center & D.VCENTER && (r.top = (o - s) / 2 + 'px')),
          a && ((a.height = n + 'px'), this.doc.options.center & D.VCENTER && (a.top = (o - n) / 2 + 'px'))),
        ni.prototype._onStart.call(this),
        this.oldScene &&
  ...
  ii.regTransType(function (t, e, i) {
    return new ri(t, e, i);
  }, A);
  var ai = _t(ri, {
    _onStart: function () {
      (this.doc.dom.style.overflow = 'hidden'), ri.prototype._onStart.call(this);
    },
    _onComplete: function () {
      ri.prototype._onComplete.call(this), (this.doc.dom.style.overflow = '');
    },
    _createAnims: function (t, e) {
      var i,
        s,
      ...
      return (
        h === P || h === R
          ? (this.newScene
              ? ((s = this.newScene.dom.offsetHeight), (i = this.oldScene ? this.oldScene.dom.offsetHeight : s))
              : (s = i = this.oldScene.dom.offsetHeight),
            (r = 'h'),
            (n = h === P ? -s : i),
            (o = 'tp'))
          : (this.newScene
              ? ((s = this.newScene.dom.offsetWidth), (i = this.oldScene ? this.oldScene.dom.offsetWidth : s))
        ...
        this.oldScene && a.push([1, [[o, [{ t: 0, d: t, es: e, s: 0, e: -n }]]]]),
        a
      );
    },
  });
  ...
  function li(t) {
    var e,
      ...
      a = {
        position: 'absolute',
        display: 'block',
        zIndex: ((o.scene && parseInt(getComputedStyle(o.scene.dom, null).zIndex)) || 0) + 1e3,
      },
      h = 15,
      l = 'a';
    (h += 'px'),
      (l += 'lt'),
      r || ((t.node = r = Q.createElement('img')), (e = 'pointer'), (e += 'Event'), (e += 's'), (r.style[e] = 'none')),
      (s = 'da'),
      (s += 'ta'),
      (s += ':i'),
      (s += 'ma'),
      ...
      (a[(e += 'Height')] = i),
      r.src !== s && (r.src = s),
      (r[l] = hi(83, 97, 111, 108, 97, 32, 65, 110, 105, 109, 97, 116, 101)),
      (a.top = a.right = h),
      (a.left = 'auto');
  ...
  var ci = _t({
      $init: function (t, e, i) {
        var s, n;
        for (this.audio = [], this.video = [], this.auIdx = -1, this.viIdx = -1, s = 0; s < e; ++s)
          (n = Q.createElement('audio')), this.audio.push(n);
        for (s = 0; s < i; ++s) (n = Q.createElement('video')), this.video.push(n);
        if (!t.isMuted()) {
          var o = Q.createElement('audio').play();
          void 0 !== o &&
            o.catch(function (e) {
              Tt('mp init error: ' + e), 'NotAllowedError' == e.name && t._mute4Autoplay();
            });
        }
      },
      resize: function (t, e) {
        for (var i; this.audio.length < t; ) (i = Q.createElement('audio')), this.audio.push(i);
        for (
          t < this.audio.length && t >= 0 && ((this.audio.length = t), this.auIdx >= t && (this.auIdx = -1));
          this.video.length < e;

        )
          (i = Q.createElement('video')), this.video.push(i);
        e < this.video.length && e >= 0 && ((this.video.length = e), this.viIdx >= e && (this.viIdx = -1));
      },
      getAudio: function () {
        var t,
          e,
      ...
      getVideo: function () {
        ...
        return Tt('mp no video'), null;
      },
      unmute: function () {
        var t, e, i;
        for (t = 0, e = this.audio.length; t < e; ++t) (i = this.audio[t]).parentNode || (i.muted = !1);
        for (t = 0, e = this.video.length; t < e; ++t) (i = this.video[t]).parentNode || (i.muted = !1);
      },
      _resetMedia: function (t) {
        var e;
        for (t.paused || t.pause(); (e = t.firstChild); ) e.removeAttribute('src'), t.removeChild(e);
        for (; t.attributes.length > 0; ) t.removeAttribute(t.attributes[0].name);
        (t.muted = !1), t.load();
      },
    }),
    di = /^sl-(doc|scene|elem)-/,
    ui = /^(?:[a-z]+:)?\/\//i,
    pi = _t(
      kt,
      {
        $init: function (t, e, i) {
          ...
          if (
            (typeof t === tt && ((s = t), (o = {})),
            (this._DEF = o),
            typeof e === tt ? ((n = e), (e = Q.getElementById(e))) : e && (n = e.id),
            (this.containerId = n),
            (this.container = e),
            typeof (i = ft({ center: D.HCENTER }, i)).center === tt)
          )
            switch (i.center) {
              case 'horizontal':
                i.center = D.HCENTER;
          ...
          (this.dom = r),
            ...
            (this.volume = isNaN(i.volume) ? 1 : wt(i.volume, 0, 1)),
                ...
                fe.ready(function () {
                  h.destroyed ||
                    ((e = Q.getElementById(n))
                      ? ((h.container = e), e.appendChild(r), h.layoutIfNeeded())
                      : Tt('Not found container id ' + n));
                });
          var l,
            c = this.getParentDoc();
          if (
            ...
            this._updateEVolume(),
            this._updateEMuted(),
            ge.isRunning() || ge.start(),
            !nt && ((!i.parentElement && !i.isPreloader) || s || o.resources))
          ) {
            var d = new ce({ holdCompletion: !0 });
            (this.preloader = d),
              (d.loadingDoc = this),
              d.bind('start', function () {
                this.loaderDoc && (this.loaderDoc.show(), this.loaderDoc.start());
              }),
              d.bind('complete', function () {
                ...
                if (!e.isPreloader && !t.scene && !t.transition) {
                  var i = { paused: e.paused, sceneTime: e.sceneTime, backward: e.backward };
                  if ((void 0 === i.paused && (i.paused = !!t.parent), typeof e.scene === tt))
                    t.showAcrossScene(), t.showScene(e.scene, i);
                  else {
                    var s = e.scene;
                    void 0 === s && (s = e.backward ? t.getScenesData().length - 1 : 0),
                      t.showAcrossScene(),
                      t.showSceneAt(s, i);
                  }
                }
          ...
          if (d && !i.isPreloader) {
            var u = new pi(i.preloaderDoc || le, this.dom, {
                isPreloader: !0,
                center: i.center,
                autofit: i.autofit,
                    ...
                    t.loadingIndicator &&
                      d.bind('progress', function () {
                        this.loaderDoc &&
                          ...
                          this.loaderDoc.loadingIndicator.setText(Math.floor(100 * this.progress) + '%');
                      }),
                    t.removeObserver(p),
                    d._bindAll(t._DEF.pe);
                },
              };
            (d.loaderDoc = u), 'loading' === u.contentState ? u.addObserver(p) : p.create(u);
          }
          var f = fe.getDoc;
          fe.getDoc = function () {
            return h;
          };
          var m = !fe.fireEvent('createdocument');
          f ? (fe.getDoc = f) : delete fe.getDoc,
            m
              ? this.destroy()
              : (this.parent || this.options.isPreloader || fe.topDocs.push(this),
                fe.docs.push(this),
                d && d.load(),
                s
                  ? (ue.bind('itemcomplete', function t(e, i) {
                      var s = i.iData;
                      if (s && s.id === h.domId)
                        if ((i.stopImmediatePropagation(), s.status === ne.TIMEOUT));
                        else {
                          if ((ue.unbind('itemcomplete', t), s.status === ne.LOADED)) {
                            var n = fe.loadedDocs.shift();
                            n
                              ? (h._DEF = n)
                              : ((h.contentState = 'error'),
                                alert('Error parsing the document. Check the browser console for more information.'));
                          } else h.contentState = 'error';
                          h._inited();
                        }
                    }),
                    ue.load({ url: s, type: 'javascript', id: this.domId }))
                  : this._inited());
        },
        _inited: function () {
          if (!this.destroyed) {
            ...
            if ('error' !== this.contentState)
              if (fe.isCompatible(this._DEF))
                this._DEF.li &&
                  fe.CanvasLoader &&
                  ((this.loadingIndicator = new fe.CanvasLoader(
                    this.dom,
                    ft({ zIndex: 1 }, this._DEF.li, this.options.preloaderOptions)
                  )),
                ...
                (t =
                  fe.docVersions[0] === fe.docVersions[1]
                    ...
                    : 'This document (version ' +
                      ...
                      ' to version ' +
                      fe.docVersions[1]),
                  fe.showMessage(t, this.dom),
                  (this._incompatibleDEF = this._DEF),
                  (this._DEF = {}),
                  (this.contentState = 'incompatible');
            if (!this.parent) {
              var e = this._DEF.mm || [];
              this.mediaPool = new ci(this, 2 * e[0], 2 * e[1]);
            }
            var i,
              s = this._DEF.scenes,
              n = 0,
            ...
            if ('loaded' == this.contentState && !this.parent && !this.options.isPreloader) {
              var r = this._DEF.k;
            ...
            if ((this.layoutIfNeeded(), this.notifyObservers('create'), 'loaded' === this.contentState)) {
              if (Q.getElementById(this.domId) === this.dom) this.isReady || ((this.isReady = !0), this.ready());
              else {
                var h = this;
                fe.ready(function () {
                  Q.getElementById(h.domId) === h.dom && (h.isReady || ((h.isReady = !0), h.ready()));
                });
              }
              if (this.preloader)
                this.preloader.add(
                  (function (t) {
                    ...
                    if (
                      ...
                      l &&
                        ...
                        c.push({
                          url: l.googleFontIncludeHeader,
                          type: 'css',
                        }),
                      l && l.resources)
                    )
                      for (e = 0, i = (a = l.resources).length; e < i; ++e)
                        switch (((o = a[e]), (h = t.getResourceFolder(o[1])), o[1])) {
                          case E.IMAGE:
                            c.push({ url: ui.test(o[3]) ? o[3] : h + o[3], type: 'image' });
                            break;
                          case E.AUDIO:
                          case E.VIDEO:
                            for (r = o[1] === E.AUDIO ? 'audio' : 'video', s = 0, n = (o = o[3]).length; s < n; ++s)
                              if (st[r][de(o[s])]) {
                                c.push({ url: ui.test(o[s]) ? o[s] : h + o[s], type: r });
                                break;
                              }
                        }
                    return c;
                ...
                if ((void 0 === l.paused && (l.paused = !!this.parent), typeof this.options.scene === tt))
                  this.showAcrossScene(), this.showScene(this.options.scene, l);
                else {
                  var c = this.options.scene;
                  void 0 === c && (c = this.options.backward ? this.getScenesData().length - 1 : 0),
        ...
        destroy: function () {
          (function (t, e) {
            ...
            Jt(
              ...
              function (t, e) {
                this.destroyed = !0;
                var i = fe.docs.indexOf(this);
                i > -1 && fe.docs.splice(i, 1),
                  (i = fe.topDocs.indexOf(this)) > -1 && fe.topDocs.splice(i, 1),
                  this.parent && ((this.parent.sym = null), (this.parent = null)),
                  this.preloader &&
                    this.preloader.loaderDoc &&
                    (this.preloader.loaderDoc.destroy(), (this.preloader.loaderDoc = null)),
          ...
          if (this.container && this.dom.clientWidth && this.dom.clientHeight) {
            ...
            1 == r
              ...
              : ((a[K.transformOrigin] = '0 0'),
                ...
                (a.margin = t = e = ''),
                this.options.center & D.HCENTER && (t = (i - n * r) / 2 + 'px'),
                this.options.center & D.VCENTER && (e = (s - o * r) / 2 + 'px'),
                (a.left = t),
                (a.top = e),
                (a.right = a.bottom = ''));
          }
          ...
          if (this.container) {
            ...
            if (this._DEF.b) {
              ...
              (i == this.hBreakpoint && s == this.vBreakpoint) ||
                ((this.hBreakpoint = i), (this.vBreakpoint = s), (t = !0), this.onLayoutSwitched());
            }
            t ||
              ...
              this.preloader && this.preloader.loaderDoc && this.preloader.loaderDoc.layoutIfNeeded();
          }
        },
        onLayoutSwitched: function () {
          if ((this.prevScene && this.prevScene.onLayoutSwitched(), this.scene)) {
            this.scene.onLayoutSwitched(), this.acrossScene && this.acrossScene.onLayoutSwitched();
            var t,
              e,
        ...
        showScene: function (t, e) {
          var i,
            ...
            o = typeof t === tt ? 'n' : 'id';
          for (i = 0, s = n.length; i < s; ++i) if (n[i][o] === t) return this.showSceneByData(n[i], e), !0;
          return !1;
        },
        ...
        showAcrossScene: function () {
          return !!this.acrossScene || this.showSceneByData(this.getAcrossSceneData());
        },
        showSceneByData: function (t, e) {
          if (t || this.scene) {
            (e = e || {}), this.transition && this.transition.goToEnd();
            var i = t ? new ii(t, this) : null;
            if (
              (i &&
                (i.sceneLayer === U.MAIN && (this.pendingScene = i),
                void 0 === e.sceneTime && (e.sceneTime = e.backward ? i.getMainTimeline().getDuration() : 0),
                i.seek(e.sceneTime),
                i.sceneLayer === U.MAIN &&
                  Jt(
                    i.getMainTimeline(),
                    ...
                    function (t, e) {
                      if (this.complete)
                        if (this.isPlayBackward()) {
                          ...
                          ((s && (s.aa || (fe.exportVideo && !t.parent))) || (!s && n && n[0] !== x && n[1])) &&
                            t.showSceneByData(s, {
                              backward: !0,
                              transition: n || { type: x },
                            });
                        } else (i.isAutoAdvance() || (fe.exportVideo && !t.parent)) && t.showNextScene();
                    },
                    !0
                  )),
              ...
              var s,
                ...
                o,
                r = e.transition;
              (s = r ? (pt(r) ? r : [r.type, r.duration, r.easing, r.option]) : t ? t.st : [x]),
                e.backward ? ((n = i), (o = this.scene)) : ((n = this.scene), (o = i)),
                (this.transition = ii.createTransition(s ? s[0] : x, n, o, s)),
                this.transition.start(e.transitionTime, e.backward, e.paused);
            }
          }
        },
        show: function (t) {
          (t = Qe(t)), (this.dom.style.display = t), 'none' != t && this.layoutIfNeeded();
        },
        pause: function () {
          this.transition ? this.transition.pause() : this.scene && this.scene.getMainTimeline().pause();
        },
        play: function () {
          this.transition ? this.transition.play() : this.scene && this.scene.getMainTimeline().play();
        },
        isPlaying: function () {
        ...
        setVolume: function (t) {
          (t = wt(t, 0, 1)) !== this.volume &&
            ((this.volume = t), this._updateEVolume(), this.muted && t && this.setMuted(!1));
        },
        getVolume: function () {
          return this.volume;
        },
        ...
        _mute4Autoplay: function () {
          if (!this.muted) {
            ...
            (this._unmuteOnTap = function () {
              Q.removeEventListener('mousedown', t._unmuteOnTap, !1), t._mute4Ap && t.setMuted(!1);
            }),
        ...
        setMuted: function (t) {
          delete this._mute4Ap,
            (t = !!t),
            this.muted !== t &&
              (!t && this.mediaPool && this.mediaPool.unmute(), (this.muted = t), this._updateEMuted());
        },
        isMuted: function () {
          return this.muted;
        },
        ...
        setSpeed: function (t) {
          t <= 0 ||
            ...
            (this.speed < 0 ? (this.speed = -t) : (this.speed = t), this._updateESpeed());
        },
        getSpeed: function () {
          return Math.abs(this.speed);
        },
        ...
        seek: function (t, e) {
          ...
          for (i = 0, s = o.length; i < s; ++i)
            if (
              ((r = a), (n = (a = o[i]).timelines ? a.timelines[0] : null) ? n.dur || (n.dur = 0) : (n = { dur: 0 }), c)
            ) {
              if (n.l && void 0 !== n.l[t]) {
                (t = n.l[t]), (h = !0);
                break;
          ...
          if ((!c && !h && s > 0 && ((h = !0), (t = n ? n.dur : 0)), !h)) return !1;
          if ((t < 0 && (t = 0), e && this.scene && this.scene._DEF == a))
            if (l) {
              if (this.transition) return this.transition.seek(t), !0;
            } else if (!this.isPlayBackward())
              return this.transition && this.transition.goToEnd(), this.scene.seek(t), !0;
          var d = { paused: !this.isPlaying(), backward: this.isPlayBackward() };
          if (l) {
            d.transitionTime = t;
            var u = { paused: !0, backward: !1, sceneTime: 0, transition: { type: x } };
            this.isPlayBackward()
              ? ((d.transition = a.st), this.showSceneByData(a, u), this.showSceneByData(r, d))
              : (r && r.timelines && r.timelines[0] && (u.sceneTime = r.timelines[0].dur || 0),
                this.showSceneByData(r, u),
                this.showSceneByData(a, d));
          } else (d.sceneTime = t), (d.transition = { type: x }), this.showSceneByData(a, d);
          return !0;
        },
        getTimeline: function (t) {
        ...
        tick: function (t) {
          this.preloader && this.preloader.loaderDoc && this.preloader.loaderDoc.tick(t),
            this.transition
              ? this.transition.timeline.tick(t)
              : this.scene && (this.acrossScene && this.acrossScene.tick(t), this.scene.tick(t));
        },
        genId: function () {
          return ++this._idPool;
        },
        genSceneDomId: function () {
          return 'sl-scene-' + this.domId.replace(di, '') + '-' + this.genId();
        },
        genElemDomId: function () {
          return 'sl-elem-' + this.domId.replace(di, '') + '-' + this.genId();
        },
        getResourceFolder: function (t) {
          for (var e = this; e && !e._DEF.resources && e.parent; ) e = e.parent.getDoc();
          e || (e = this);
        ...
        getMediaPool: function () {
          for (var t = this; t && !t.mediaPool && t.parent; ) t = t.parent.getDoc();
          return (t && t.mediaPool) || null;
        },
        getFunction: function (t) {
          for (var e = this, i = typeof t === tt ? 1 : 0; e && !e._DEF.f && e.parent; ) e = e.parent.getDoc();
          if (e && e._DEF.f) {
            var s,
              n = e._DEF.f,
              o = n.length;
        ...
        getElement: function (t) {
          var e,
            ...
            s = null;
          return (
            pt(t) ? ((t = t[0]), (e = this.acrossScene)) : ((e = this.scene), (i = typeof t == tt)),
            e && (s = e.getElement(t)),
        ...
        getElementsByClassName: function (t) {
          ...
          return (
            ...
            this.acrossScene && (e = e.concat(this.acrossScene.getElementsByClassName(t))),
            e
          );
        },
        findElementByDom: function (t) {
          ...
          return (
            ...
            !e && this.acrossScene && (e = this.acrossScene.findElementByDom(t)),
            e
          );
        },
        ...
        try {
          ...
          if (e) {
            var i = e[0].trim().toLowerCase(),
              s = e[1];
            if (i) (t = 'svg' == i ? Q.createElementNS(_i, i) : Q.createElement(i)).innerHTML = s;
            else {
          ...
          Tt('CustomElemCreateErr: ' + t);
        }
        return t || (t = Q.createElement('div')), (t.style.pointerEvents = 'auto'), t;
      },
      _updatePointerEvents: function () {},
  ...
  var mi = _t(ei, {
    $init: function (t, e) {
      (this.BgX = 0),
        ...
        ei.prototype.$init.call(this, t, e);
    },
    create: function () {
      var t, e;
      switch (this._imageType) {
        case z:
          return ((e = (t = Q.createElement('img')).style).pointerEvents = 'auto'), t.setAttribute('draggable', !1), t;
        case $:
          return ((t = ei.prototype.create.call(this)).style.pointerEvents = 'auto'), t;
        default:
          return (
            ...
            (t = ei.prototype.create.call(this)).appendChild(this.imgDom),
            t
          );
      }
    },
    ...
    setResource: function (t) {
      switch (this._imageType) {
        case X:
          (this.imgDom.style.backgroundImage = 'none'),
            (this.imgDom.style.backgroundImage = 'url("' + t.replace(/"/g, '\\"') + '")');
          break;
        case z:
          this.dom.src = t;
      }
    ...
    setBgImg: function (t) {
      this._imageType == X &&
        ((this.BgX = St(t[0]) ? t[0] + 'px' : t[0]),
        (this.BgY = St(t[1]) ? t[1] + 'px' : t[1]),
        (this.BgW = St(t[2]) ? t[2] + 'px' : t[2]),
        (this.BgH = St(t[3]) ? t[3] + 'px' : t[3]),
    ...
    setBgImgX: function (t) {
      this._imageType == X &&
        ((this.BgX = St(t) ? t + 'px' : t), (this.imgDom.style.backgroundPosition = this.BgX + ' ' + this.BgY));
    },
    setBgImgY: function (t) {
      this._imageType == X &&
        ((this.BgY = St(t) ? t + 'px' : t), (this.imgDom.style.backgroundPosition = this.BgX + ' ' + this.BgY));
    },
    setBgImgW: function (t) {
      this._imageType == X &&
        ((this.BgW = St(t) ? t + 'px' : t), (this.imgDom.style.backgroundSize = this.BgW + ' ' + this.BgH));
    },
    setBgImgH: function (t) {
      this._imageType == X &&
        ((this.BgH = St(t) ? t + 'px' : t), (this.imgDom.style.backgroundSize = this.BgW + ' ' + this.BgH));
    },
  });
  ii.regElemType(function (t, e) {
    return new mi(t, e);
  ...
  var gi = _t(ei, {
      $init: function (t, e) {
        (this.speed = 1), (this.volume = 1), (this.muted = !1), ei.prototype.$init.call(this, t, e);
        var i = this.getDoc(),
          s = this;
        if (
          (i &&
      ...
      create: function () {
        ...
        return (
          ...
          fe.exportVideo && (e.style.display = 'none'),
          t.appendChild(e),
          (this.mediaDom = e),
          (this._updateFromDom = function (t) {
            ...
            'volumechange' === t.type
              ? ((this.muted && e.isEffectiveMuted()) || (i.muted = this.muted),
                (i.volume = e ? this.volume / e.getEffectiveVolume() : this.volume))
              : 'ratechange' === t.type &&
                (i.speed = e ? this.playbackRate / e.getEffectiveSpeed() : this.playbackRate);
          }),
      ...
      _onRemovedFromDoc: function () {
        this.mediaDom.removeEventListener('volumechange', this._updateFromDom, !1),
          this.mediaDom.removeEventListener('ratechange', this._updateFromDom, !1),
          this.mediaDom.removeEventListener('loadedmetadata', this._loadedMetaData, !1);
        try {
          var t;
          for (this.mediaDom.paused || this.mediaDom.pause(); (t = this.mediaDom.firstChild); )
            t.removeAttribute('src'), this.mediaDom.removeChild(t);
          this.mediaDom.removeAttribute('src'),
            nt || this.mediaDom.load(),
            this.mediaDom.parentNode && this.mediaDom.parentNode.removeChild(this.mediaDom);
        } catch (t) {
          Tt('remove media error ' + t);
        }
        var e = this.getDoc();
      ...
      setResource: function (t) {
        ...
        for (
          e && (delete this._pendingVol, delete this._pendingMuted, delete this._pendingPlay, delete this._pendingSeek);
          e;

        )
          (e.src = ''), this.mediaDom.removeChild(e), (e = this.mediaDom.firstChild);
      ...
      setVolume: function (t) {
        if (this.mediaDom.readyState < 1) this._pendingVol = t;
          ...
          var e = this.getDoc();
          (this.mediaDom.volume = wt(e ? e.getEffectiveVolume() * t : t, 0, 1)),
      ...
      play: function () {
        if (this.mediaDom.readyState < 1) this._pendingPlay = !0;
          ...
          delete this._pendingPlay, this._replayingOnError ? delete this._replayingOnError : (this._replayIfError = 2);
          var t = this.mediaDom.play();
          if (void 0 !== t) {
            var e = this;
            t.catch(function (t) {
              if ((Tt('error play media: ' + e.name + ', ' + t), 'NotAllowedError' == t.name)) {
                if (!e._tryPlayMuted) {
                  e._tryPlayMuted = !0;
                  var i = e;
                  if ('video' == e.mediaDom.nodeName.toLowerCase()) e.setMuted(!0), e.play();
                  else {
                    var s = e.getDoc();
                    if (s) {
      ...
      pause: function () {
        delete this._pendingPlay, delete this._replayIfError, this.mediaDom.pause();
      },
      seek: function (t) {
      ...
      setSpeed: function (t) {
        this.speed = t;
        var e = this.getDoc();
        this.mediaDom.defaultPlaybackRate = this.mediaDom.playbackRate = e ? e.getEffectiveSpeed() * t : t;
      },
      isPlaying: function () {
    ...
    vi = _t(gi, {
      createMedia: function () {
        var t = this.getDoc(),
          ...
          s = i.style;
        return (s.display = 'block'), (s.width = '100%'), (s.height = '100%'), i.setAttribute('playsinline', ''), i;
      },
      create: function () {
        var t = gi.prototype.create.call(this);
        if (fe.exportVideo) {
      ...
      playFullscreen: function () {
        this.mediaDom.requestFullscreen
          ...
          ? this.mediaDom.mozRequestFullScreen()
          : this.mediaDom.webkitRequestFullscreen && this.mediaDom.webkitRequestFullscreen();
      },
  ...
  var _i = 'http://www.w3.org/2000/svg',
    Ti = 'userSpaceOnUse',
    wi = {},
    Si = {},
    bi = _t({
      $init: function (t) {
        ...
        (this.cXs = i), (this.cYs = s), (this.minX = n), (this.minY = o), (this.maxX = r), (this.maxY = a);
      },
    }),
    Ei = _t({
      $init: function (t) {
    ...
    Di = _t({
      ...
      arcTo: function (t, e, i, s, n, o) {
        this.path += ' A' + t + ',' + e + ' 0 ' + (n ? 1 : 0) + ',' + (o ? 1 : 0) + ' ' + i + ',' + s;
      },
      ...
      addRect: function (t, e, i, s) {
        this.moveTo(t, e), this.lineTo(t + i, e), this.lineTo(t + i, e + s), this.lineTo(t, e + s), this.closeSubpath();
      },
      ...
      addStar: function (t, e, i, s, n, o) {
        ...
        for (
          ...
          this.lineTo(t + (h[2 * r] - c) * u, e + (l[2 * r] - d) * p),
            this.lineTo(t + (h[2 * r + 1] * n - c) * u, e + (l[2 * r + 1] * n - d) * p);
        this.closeSubpath();
      },
      addPolygon: function (t, e, i, s, n) {
        var o,
          r = Si[n] || (Si[n] = new Ei(n)),
          a = r.cXs,
          h = r.cYs,
          l = r.minX,
          c = r.minY,
          d = i / (r.maxX - l),
          u = s / (r.maxY - c);
        for (this.moveTo(t + (a[0] - l) * d, e + (h[0] - c) * u), o = 1; o < n; ++o)
      ...
      addMarker: function (t, e, i) {
        ...
        switch (
          ...
          case b.ARROW:
            this.moveTo(0, 0), this.lineTo(n, -o / 2), this.lineTo(n, o / 2), this.closeSubpath();
            break;
          case b.OPEN:
            var r = Math.atan2(o / 2, n),
              a = Math.floor(i / Math.sin(r) / 2);
            this.moveTo(n + a, -o / 2), this.lineTo(a, 0), this.lineTo(n + a, o / 2);
            break;
          case b.STEALTH:
            this.moveTo(0, 0),
              this.lineTo(n, -o / 2),
  ...
  function xi(t, e) {
    ...
    for (n = 0, o = e.length; n < o; ++n)
      1 === (i = e[n])[6] || 0 === n ? t.moveTo(i[0], i[1]) : t.cubicTo(s[4], s[5], i[2], i[3], i[0], i[1]), (s = i);
    (r = e).length > 1 &&
      2 === r[r.length - 1][6] &&
      ((i = e[0]), t.cubicTo(s[4], s[5], i[2], i[3], i[0], i[1]), t.closeSubpath());
  }
  ...
  var Ci = {
    gen: function (t, e, i, s, n, o) {
      ...
      return (
        this.hasOwnProperty(t)
          ...
          : t >= S.STAR_MIN && t <= S.STAR_MAX && r.addStar(e, i, s, n, o[0], t - S.STAR_MIN),
        r.getPath()
      );
    },
    ...
    17: function (t, e, i, s, n, o) {
      ...
      Math.min(s, n) * o[0] < 0 ? (r = i) : Math.min(s, n) * o[0] > n && (r = i + n);
      var a = e + (s / 2) * o[1];
      t.moveTo(a, i + n),
        t.lineTo(a, r),
        t.lineTo(e, r),
    ...
    18: function (t, e, i, s, n, o) {
      ...
      n - Math.min(s, n) * o[0] < 0 ? (a = i) : n - Math.min(s, n) * o[0] > n && (a = i + n),
    ...
    19: function (t, e, i, s, n, o) {
      var r = e + (s / 2) * (1 + o[0]),
        ...
        c = h + (14 * j) / 180;
      t.moveTo(r, a),
        t.lineTo(e + s / 2 + (s / 2) * Math.cos(c), i + n / 2 + (n / 2) * Math.sin(c)),
        t.arcTo(s / 2, n / 2, e + s / 2 + (s / 2) * Math.cos(l), i + n / 2 + (n / 2) * Math.sin(l), !0, !0),
        t.closeSubpath();
    },
    ...
    33: function (t, e, i, s, n, o) {
      t.moveTo(e + o[0] * s, i), t.lineTo(e + s, i + n), t.lineTo(e, i + n), t.closeSubpath();
    },
    34: function (t, e, i, s, n) {
      t.moveTo(e, i), t.lineTo(e + s, i + n), t.lineTo(e, i + n), t.closeSubpath();
    },
    35: function (t, e, i, s, n) {
      t.moveTo(e + 0.2 * s, i), t.lineTo(e + s, i), t.lineTo(e + 0.8 * s, i + n), t.lineTo(e, i + n), t.closeSubpath();
    },
    ...
    56: function (t, e, i, s, n) {
      t.moveTo(e + s / 2, i + n / 4),
        t.cubicTo(e + 0.75 * s, i - n / 3, e + 1.5 * s, i + n / 4, e + s / 2, i + n),
        t.cubicTo(e - s / 2, i + n / 4, e + s / 4, i - n / 3, e + s / 2, i + n / 4),
        t.closeSubpath();
    },
    57: function (t, e, i, s, n, o) {
      t.moveTo(e + s, i),
        t.cubicTo(e + o[0] * s, i, e + o[0] * s, i + n / 2, e + o[0] * s, i + n / 2),
    ...
    61: function (t, e, i, s, n, o) {
      var r = o[0] * Math.min(s / 2, n / 2);
      t.moveTo(e + r, i), t.lineTo(e + s - r, i), t.lineTo(e + s, i + n), t.lineTo(e, i + n), t.closeSubpath();
    },
    ...
    74: function (t, e, i, s, n) {
      t.moveTo(e + s / 6, i),
        t.lineTo(e + s, i),
        t.cubicTo(e + (7 * s) / 9, i - n / 35, e + (7 * s) / 9, i + (36 * n) / 35, e + s, i + n),
        t.lineTo(e + s / 6, i + n),
        t.cubicTo(e - s / 18, i + (36 * n) / 35, e - s / 18, i - n / 35, e + s / 6, i),
        t.closeSubpath();
    },
    75: function (t, e, i, s, n, o) {
      ...
      r <= 0
        ? (t.moveTo(e - 2 * r, i + a),
          t.cubicTo(e + s / 4 - 2 * r, i - 2.5 * a, e + (3 * s) / 4, i + 5 * a, e + s, i + a),
          t.lineTo(e + s + 2 * r, i + n - a),
          t.cubicTo(e + (3 * s) / 4 + 2.2 * r, i + n + 2.5 * a, e + s / 4, i + n - 5 * a, e, i + n - a),
          t.lineTo(e - 2 * r, i + a),
          t.closeSubpath())
        : (t.moveTo(e, i + a),
          t.cubicTo(e + s / 4, i - 2.5 * a, e + (3 * s) / 4 - 2 * r, i + 5 * a, e + s - 2 * r, i + a),
          t.lineTo(e + s, i + n - a),
          t.cubicTo(e + (3 * s) / 4, i + n + 2.5 * a, e + s / 4 + 2 * r, i + n - 5 * a, e + 2 * r, i + n - a),
          t.lineTo(e, i + a),
          t.closeSubpath());
    },
  ...
  var Pi = _t(ei, {
    create: function () {
      ...
      return (
        ...
        (this.painter = new Ke(e)),
        t
      );
    },
    _initText: function () {
      this.textDom || (ei.prototype._initText.call(this), this._updateTextRect());
    },
    _updateTextRect: function () {
      if (this.textContainer) {
        var t = this.textContainer.style;
        (t.left = '0%'), (t.top = '0%'), (t.width = '100%'), (t.height = '100%');
      }
    },
    _onResized: function (t, e) {
      this._updateTextRect(), ei.prototype._onResized.call(this, t, e);
    },
  });
  ii.regElemType(function (t, e) {
    return new Pi(t, e);
  ...
  var Ri = _t(Pi, {
    ...
    setBottomLeftRadius: function (t) {
      var e = St(t) ? t + 'px' : t;
      (this.painter.dom.style.borderBottomLeftRadius = e), this._updateTextRect();
    },
    setBottomRightRadius: function (t) {
      var e = St(t) ? t + 'px' : t;
      (this.painter.dom.style.borderBottomRightRadius = e), this._updateTextRect();
    },
    _updateTextRect: function () {
      if (this.textContainer) {
        var t = Ri.getTextRect(this, 10),
          e = this.textContainer.style;
        (e.left = t.left + 'px'), (e.top = t.top + 'px'), (e.width = t.width + 'px'), (e.height = t.height + 'px');
      }
    },
  });
  ii.regElemType(function (t, e) {
    ...
    (Ri.getTextRect = function (t, e) {
      ...
      var a = function (t) {
          ...
          return (
            e &&
              ((n.x = e.value),
              (n.y = e.value),
              '%' === e.unit && ((n.isPixel = !1), (n.x = (e.value * i) / 100), (n.y = (e.value * s) / 100))),
            n
          );
        },
        h = function (t) {
      ...
      var y = h(c),
        ...
        D = e + Math.max(T.y, w.y);
      return (
        S > n && ((S = n), (b = 0)),
        E > o && ((E = o), (D = 0)),
        { left: S, top: E, width: n - S - b, height: o - E - D }
      );
    });
  var Oi = _t(Ke, {
      $init: function (t) {
      ...
      _createPathNodes: function () {
        ...
        this.hasArrow()
          ? this._lineGroup ||
            ...
            this.svgPath &&
              ...
              this.svgPath == this._fillPath &&
                (this._fillPath.removeAttribute('transform'), this._fillPath.removeAttribute('filter'), (i = !0))),
            this._fillPath || (this._fillPath = Q.createElementNS(_i, 'path')),
            i &&
              ((this.svgPath = Q.createElementNS(_i, 'g')),
              this.svgPath.appendChild(this._fillPath),
              this.dom.appendChild(this.svgPath)),
            (this._lineGroup = Q.createElementNS(_i, 'g')),
            (this._linePath = Q.createElementNS(_i, 'path')),
            this._lineGroup.appendChild(this._linePath),
            (this._lineStart = Q.createElementNS(_i, 'path')),
            ((t = this._lineStart.style).strokeLinecap = 'round'),
            (t.strokeLinejoin = 'miter'),
            this._lineGroup.appendChild(this._lineStart),
            (this._lineEnd = Q.createElementNS(_i, 'path')),
          ...
          : i &&
            ((this._fillPath = this._linePath = Q.createElementNS(_i, 'path')),
            dt || st.svgShadowBox
              ? (this.svgPath = this._fillPath)
              : ((this.svgPath = Q.createElementNS(_i, 'g')), this.svgPath.appendChild(this._fillPath)),
            this.dom.appendChild(this.svgPath)),
          i &&
      ...
      _arrowData: function (t) {
        void 0 !== t[2]
          ...
          void 0 !== t[4] ? (this._startArrow = { type: t[4], size: t[5] }) : delete this._startArrow;
      },
      _updateArrows: function () {
        !this._lineGroup && this.hasArrow()
          ? this._createPathNodes()
          : (this._updatePath(), this.setBorderColor(this._lineColor, this._lineAlpha));
      },
      ...
      hasArrow: function () {
        return (
          (this._startArrow && this._startArrow.type != b.NONE) || (this._endArrow && this._endArrow.type != b.NONE)
        );
      },
      setBorderStyle: function (t) {
        if (((this._lineStyle = t), delete this._lineDash, 'none' == t))
          this._lineGroup ? (this._lineGroup.style.display = t) : (this._linePath.style.stroke = t);
        else {
          this._lineGroup ? (this._lineGroup.style.display = '') : (this._linePath.style.stroke = this._lineColor);
          ...
          'dotted' == t
            ...
            : 'solid' != t && (this._lineDash = Ne(t)),
            void 0 !== this._lineFullLen
              ? this._updateLineDraw()
              : (this._linePath.style.strokeDasharray = (this._lineDash && this._lineDash.join(' ')) || 'none');
        }
      ...
      setLineCap: function (t) {
        (this._lineCap = t), (this._linePath.style.strokeLinecap = t), this.setBorderStyle(this._lineStyle);
      },
            ...
            ? ((t /= 100),
              1 == Math.abs(t % 2)
                ? ((this._linePath.style.strokeDasharray = (this._lineDash && this._lineDash.join(' ')) || 'none'),
                  ...
                  this._lineDrawFull || ((this._lineDrawFull = !0), this.hasArrow() && this._updatePath()))
                : (this._lineDrawFull &&
                    (delete this._lineDrawFull, this._updateLineDraw(!0), this.hasArrow() && this._updatePath()),
      ...
      _updateLineDraw: function (t) {
        var e = this._lineFullLen,
          ...
          s = 'none',
          n = void 0 === e;
        if (((t && !n) || (this._lineFullLen = e = Math.ceil(this._linePath.getTotalLength())), 'solid' == i)) s = e;
      ...
      setBorderColor: function (t, e, i, s) {
        var n;
        typeof t === tt ? ((this._lineColor = t), (s = e)) : (this._lineColor = xt(t, e, i)),
              ...
              this._lineEnd &&
                ...
                this._endArrow && this._endArrow.type !== b.NONE
                  ? this._endArrow.type === b.OPEN
                    ...
                    : ((n.stroke = 'none'), (n.fill = this._lineColor))
                  : (n.stroke = n.fill = 'none')))
            : ('none' !== this._lineStyle && (this._linePath.style.stroke = this._lineColor),
      ...
      _preventLineBlurry: function () {
        ...
        t && 'none' !== this._lineStyle
          ? this.svgPath.setAttribute('transform', 'translate(' + t + ', ' + t + ')')
          : this.svgPath.removeAttribute('transform');
      },
      fillNone: function () {
        (this.fillType = h), (this._fillPath.style.fill = 'none'), (this._gradient = null);
      },
      fillSolid: function (t, e, i, s) {
        (this.fillType = l),
          (this._fillPath.style.fill = xt(t, e, i)),
          void 0 === s && (s = 255),
      ...
      fillImage: function (t, e, i, s, n) {
        ...
        if (
          (this._imageFillData
            ? ((this._imageFillData[1] = i), (this._imageFillData[2] = s), (this._imageFillData[3] = n))
            : (this._imageFillData = ['', i, s, n]),
          !this.svgImgPattern)
        ) {
          var r = Q.createElementNS(_i, 'pattern');
          (r.id = 'sl-imgfill-' + Et()),
        ...
        if (
          (this.svgImage ||
            ((this.svgImage = Q.createElementNS(_i, 'image')), this.svgImgPattern.appendChild(this.svgImage)),
          t && t !== this._imageFillData[0])
        )
          (this._imageFillData[0] = t), this.svgImage.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', t);
        else if (!t) return (this._imageFillData[0] = ''), void (o.fill = 'none');
        var a = {
            x: '0%',
            y: '0%',
            width: '100%',
      ...
      fillLinearGradient: function (t, e) {
        ...
        var i,
          ...
          y =
            ...
            (r %= 360) < 0 && (r += 360),
            r < 90
              ? ((h = a.x), (l = a.y + a.height), (d = a.x + a.width), (u = a.y))
              : r < 180
              ? ((h = a.x), (l = a.y), (d = a.x + a.width), (u = a.y + a.height))
              : r < 270
              ? ((d = a.x), (u = a.y + a.height), (h = a.x + a.width), (l = a.y))
              : ((d = a.x), (u = a.y), (h = a.x + a.width), (l = a.y + a.height)),
            {
              x1: ((p * h - l) * p) / f,
              y1: (-p * h + l) / f,
              x2: ((p * d - u) * p) / f,
          ...
          _ = !e,
          T = _ ? this.svgLGrad : Q.createElementNS(_i, 'linearGradient');
        if (T)
          if (
            ...
            for (
              T.id = 'sl-lgrad-' + Et(), T.setAttribute('gradientUnits', 'userSpaceOnUse'), i = 0, s = e.length;
              i < s;
              ++i
            )
              (n = e[i]),
                g.push(n.slice()),
                (o = Q.createElementNS(_i, 'stop')).setAttribute('offset', n[0] + '%'),
                o.setAttribute('stop-color', xt(n[1], n[2], n[3])),
                o.setAttribute('stop-opacity', void 0 === n[4] ? 1 : n[4] / 255),
                T.appendChild(o);
      ...
      fillRadialGradient: function (t, e, i, s, n) {
        ...
        var o,
          ...
          u = [],
          p = !i,
          f = p ? this.svgRGrad : Q.createElementNS(_i, 'radialGradient');
        if (f) {
          if (p) {
            if (!this._gradient || this._gradient[0] != y) return;
            void 0 === t ? (t = this._gradient[1]) : (this._gradient[1] = t),
          ...
          var m, g, v, w, S, b, E, D, x, A, C, M, P, R, O, I, k;
          if (
            ((m = t),
            (g = e),
            (v = s),
            ...
            w == T.CLOSE_SIDE || w == T.CLOSE_CORNER
              ? ((b = Math.min(C, M)),
                (E = Math.min(P, R)),
                v == _.CIRCLE
                  ? (D = w == T.CLOSE_SIDE ? Math.min(b, E) : Math.sqrt(b * b + E * E))
                  : 0 == b || 0 == E
                  ? (D = 0)
                  : b >= E
                  ? ((D = w == T.CLOSE_SIDE ? b : Math.sqrt(2) * b), (I = E / b))
                  : ((D = w == T.CLOSE_SIDE ? E : Math.sqrt(2) * E), (O = b / E)))
              : ((b = Math.max(C, M)),
                (E = Math.max(P, R)),
                v == _.CIRCLE
                  ? (D = w == T.FAR_SIDE ? Math.max(b, E) : Math.sqrt(b * b + E * E))
                  : 0 == b || 0 == E
                  ? (D = 0)
                  : b >= E
                  ? ((D = w == T.FAR_SIDE ? b : Math.sqrt(2) * b), (I = E / b))
                  : ((D = w == T.FAR_SIDE ? E : Math.sqrt(2) * E), (O = b / E))),
            (1 == O && 1 == I) ||
              (k = 'translate(' + x + ',' + A + ') scale(' + O + ',' + I + ') translate(' + -x + ',' + -A + ')'),
            (l = {
              x: x,
              y: A,
              r: D,
            ...
            '' === l.t ? f.removeAttribute('gradientTransform') : f.setAttribute('gradientTransform', l.t),
            !p)
          ) {
            for (
              f.id = 'sl-rgrad-' + Et(), f.setAttribute('gradientUnits', 'userSpaceOnUse'), o = 0, r = i.length;
              o < r;
              ++o
            )
              (a = i[o]),
                u.push(a.slice()),
                (h = Q.createElementNS(_i, 'stop')).setAttribute('offset', a[0] + '%'),
                h.setAttribute('stop-color', xt(a[1], a[2], a[3])),
                h.setAttribute('stop-opacity', void 0 === a[4] ? 1 : a[4] / 255),
                f.appendChild(h);
      ...
      _obCreateSVGShadow: function () {
        if (!this._svgShadowCreated) {
          (this._filterNode = Q.createElementNS(_i, 'filter')),
            (this._filterNode.id = 'sl-dropshadow-' + Et()),
            (this._feFloodNode = Q.createElementNS(_i, 'feFlood')),
            (this._feCompositeNode1 = Q.createElementNS(_i, 'feComposite')),
            (this._feOffsetNode = Q.createElementNS(_i, 'feOffset')),
            (this._feGaussianBlurNode = Q.createElementNS(_i, 'feGaussianBlur')),
            (this._feCompositeNode2 = Q.createElementNS(_i, 'feComposite'));
          ...
          t.appendChild(this._feFloodNode),
            ...
            st.svgShadowBox ||
              ((this._shadowBoxNode = Q.createElementNS(_i, 'path')),
            ...
            Dt(this._feFloodNode, { result: 'flood' }),
            Dt(this._feCompositeNode1, {
              result: 'composite1',
              operator: 'in',
              in2: 'SourceGraphic',
              in: 'flood',
            }),
            Dt(this._feOffsetNode, {
              result: 'offset',
              in: 'composite1',
            }),
            this._feGaussianBlurNode &&
              Dt(this._feGaussianBlurNode, {
                result: 'blur',
                in: 'offset',
              }),
            Dt(this._feCompositeNode2, {
              result: 'composite2',
              operator: 'over',
              in2: 'blur',
              in: 'SourceGraphic',
            }),
            this.svgPath.setAttribute('filter', 'url(#' + this._filterNode.id + ')'),
      ...
      _obRemoveSVGShadow: function () {
        this._svgShadowCreated &&
          ...
          this._shadowBoxNode && (this.svgPath.removeChild(this._shadowBoxNode), delete this._shadowBoxNode));
      },
      _obShadow: function () {
        this._obBgShadow(
          this._shadowRadius,
      ...
      _obBgShadow: function (t, e, i, s, n) {
        if (void 0 !== t) {
          ...
          if (
            ...
            var f = new Di();
            f.addRect(r, a, h - r, l - a), this._shadowBoxNode.setAttribute('d', f.getPath());
          }
          Dt(this._filterNode, { x: r, y: a, width: h - r, height: l - a }),
            Dt(this._feFloodNode, {
              'flood-color': s,
              'flood-opacity': n / 255,
            }),
            Dt(this._feOffsetNode, {
            ...
            Dt(this._feCompositeNode2, { in2: t > 0 ? 'blur' : 'offset' }),
            this._feGaussianBlurNode && Dt(this._feGaussianBlurNode, { stdDeviation: t / 4 });
      ...
      setPath: function (t, e, i) {
        if (((this._path = t), void 0 === e || void 0 === i)) {
          var s = (function (t) {
            var e = Q.createElementNS(_i, 'svg'),
              i = Q.createElementNS(_i, 'path'),
              s = e.style;
            if (((s.position = 'absolute'), (s.top = s.left = '-10000px'), (s.visibility = 'hidden'), typeof t != tt)) {
              var n = new Di();
              xi(n, t), (t = n.getPath());
            }
          ...
          if (typeof this._path == tt)
            Math.abs(this._w4path - i) > 1 || Math.abs(this._h4path - s) > 1
              ? (e.line = e.fill =
                  ...
                  })(this._path, this._w4path ? i / this._w4path : 1, this._h4path ? s / this._h4path : 1))
              ...
              (Math.abs(this._w4path - i) > 1 || Math.abs(this._h4path - s) > 1) &&
                (f = (function (t, e, i) {
                  ...
                  for (s = 0, n = t.length; s < n; ++s)
                    (r = [(o = t[s])[0] * e, o[1] * i, o[2] * e, o[3] * i, o[4] * e, o[5] * i]),
                      o.length > 6 && r.push(o[6]),
                      a.push(r);
                  return a;
                })(f, this._w4path ? i / this._w4path : 1, this._h4path ? s / this._h4path : 1)),
                f.length > 1 &&
                  this._lineWidth > 0 &&
                  ...
                  (this._startArrow &&
                    ...
                    ((n = f[0].slice())[5] != n[1] || n[4] != n[0]
                      ...
                      : ((r = f[1]),
                        (h = 2 * (1 - (a = 0.01)) * a),
                        (l = a * a),
                        (c = Math.atan2(h * (r[3] - n[5]) + l * (r[1] - r[3]), h * (r[2] - n[4]) + l * (r[0] - r[2])))),
                    p.clear(),
                    p.addMarker(this._startArrow.type, this._startArrow.size, this._lineWidth),
                    (e.startArrow = p.getPath()),
                    (e.startArrowTransform = 'translate(' + n[0] + ',' + n[1] + ') rotate(' + (180 * c) / j + ')'),
                    (d = Ai(this._startArrow.type, this._startArrow.size, this._lineWidth)),
                    (f[0][0] += d * Math.cos(c)),
                    (f[0][1] += d * Math.sin(c))),
                  this._endArrow &&
                    this._endArrow.type !== b.NONE &&
                    ((o = f[(u = f.length - 1)].slice())[3] != o[1] || o[2] != o[0]
                      ? (c = Math.atan2(o[3] - o[1], o[2] - o[0]))
                      : ((r = f[u - 1]),
                        (h = (a = 0.01) * a),
                        (l = 2 * (1 - a) * a),
                        (c = Math.atan2(h * (r[1] - r[5]) + l * (r[5] - o[3]), h * (r[0] - r[4]) + l * (r[4] - o[2])))),
                    p.clear(),
                    p.addMarker(this._endArrow.type, this._endArrow.size, this._lineWidth),
                    (e.endArrow = p.getPath()),
                    (e.endArrowTransform = 'translate(' + o[0] + ',' + o[1] + ') rotate(' + (180 * c) / j + ')'),
                    (d = Ai(this._endArrow.type, this._endArrow.size, this._lineWidth)),
                    (f[u][0] += d * Math.cos(c)),
                    (f[u][1] += d * Math.sin(c)))),
                p.clear(),
                xi(p, f),
                ...
                (n || o) && (p.clear(), xi(p, f)),
                (e.fill = p.getPath());
          } else e.fill = e.line = Ci.gen(this._shapeType, 0, 0, i, s, this._shapeAdjs);
          this._fillPath.setAttribute('d', e.fill || ''),
            this._linePath != this._fillPath && this._linePath.setAttribute('d', e.line || ''),
            this._lineStart &&
              (this._lineStart.setAttribute('d', e.startArrow || ''),
              e.startArrowTransform
                ? this._lineStart.setAttribute('transform', e.startArrowTransform)
      ...
      _createDefs: function () {
        this.svgDefs || ((this.svgDefs = Q.createElementNS(_i, 'defs')), this.dom.appendChild(this.svgDefs));
      },
      ...
      layout: function () {
        if ((this._updatePath(), this.fillType === c)) {
          ...
          t &&
            (t[0] == y ? this.fillRadialGradient(t[1], t[2], t[3], t[4], t[5]) : this.fillLinearGradient(t[1], t[2]));
        } else
          this.fillType === d &&
            this.fillImage(
              this._imageFillData[0],
    ...
    Ii = _t(Pi, {
      $init: function (t, e) {
        Pi.prototype.$init.call(this, t, e);
      },
      create: function () {
        var t = ei.prototype.create.call(this),
          e = Q.createElementNS(_i, 'svg'),
          i = e.style;
        (i.width = '100%'),
          (i.height = '100%'),
          (i.minWidth = '1px'),
          ...
          (this.painter = new Oi(this.svgNode));
        var s = this._getPropsData();
        if (s && s.s) {
          var n = s.s;
          n[0] >= S.FREEFORM_MIN && n[0] <= S.FREEFORM_MAX && this.painter._arrowData(n);
        }
      ...
      _onResized: function (t, e) {
        this.painter.layout(), this._obRefreshShadow(), Pi.prototype._onResized.call(this, t, e);
      },
      _shapePathData: function (t) {
  ...
  gt(Ii.prototype, 'painter', [
    ...
    (Ii.getShapeStars = function (t) {
      return wi[t] || (wi[t] = new bi(t));
    }),
    (Ii.getShapePolygon = function (t) {
      return Si[t] || (Si[t] = new Ei(t));
    }),
    (Ii.getAdjsPoint = function (t, e, i, s, n, o) {
      ...
      switch (r) {
        ...
        case S.RIGHT_ARW:
          0 === o
            ? ((d = s - Math.min(s, n) * a[0]) < 0 ? (d = 0) : d > s && (d = s), (h = e + d), (l = i))
            : 1 === o && ((h = e), (l = i + (n / 2) * a[1]));
          break;
        case S.UP_ARW:
          0 === o
            ? ((h = e),
              ...
              Math.min(s, n) * a[0] < 0 ? (l = i) : Math.min(s, n) * a[0] > n && (l = i + n))
        ...
        case S.LEFT_RIGHT_ARW:
          0 === o
            ? ((h = e + (a[0] * s) / 2), (l = i))
            : 1 === o && ((h = e + s - (a[0] * s) / 2), (l = i + (n / 2) * a[1]));
          break;
        case S.UP_DOWN_ARW:
          0 === o
            ? ((h = e), (l = i + (a[1] * n) / 2))
            : 1 === o && ((h = e + a[0] * (s / 2)), (l = i + n - (a[1] * n) / 2));
          break;
        ...
        case S.NOTCH_RIGHT_ARW:
          0 === o ? ((h = e + s - s * a[0]), (l = i)) : 1 === o && ((h = e + s), (l = i + (n / 2) * a[1]));
          break;
        case S.WAVE:
          0 === o ? ((h = e), (l = i + (n / 2) * a[0])) : 1 === o && ((h = e + s / 2 + (s / 2) * a[1]), (l = i + n));
          break;
        case S.PENTAGON:
          0 === o && ((h = e + s - wt(a[0] * Math.min(s, n), 0, s)), (l = i));
          break;
        default:
          if (r >= S.STAR_MIN && r <= S.STAR_MAX) {
            var m = a[0],
              g = r - S.STAR_MIN,
              v = Ii.getShapeStars(g);
    ...
    (Ii.getTextRect = function (t) {
      ...
      switch (h) {
        ...
        case S.ROUND_RECT:
          ...
          return l({ left: 0 + (e = c * (1 - 1 / Math.sqrt(2))), top: 0 + e, width: r - 2 * e, height: a - 2 * e });
        case S.ROUND_RECT_THOUGHT:
        case S.ROUND_RECT_COUT:
          return l({
        ...
        case S.DIAMOND:
          return l({ left: 0 + (i = r / 4), top: 0 + (s = a / 4), width: r - 2 * i, height: a - 2 * s });
        case S.HEART:
          return l({ left: 0 + 0.2 * r, top: 0 + 0.25 * a, width: 0.6 * r, height: 0.4 * a });
        case S.CROSS:
          return l({ left: 0 + (e = o[0] * Math.min(r / 2, a / 2)), top: 0 + e, width: r - 2 * e, height: a - 2 * e });
        case S.PLAQUE:
          return l({
            left: 0 + (e = o[0] * Math.min(r / 2, a / 2) * Math.cos(Math.PI / 4)),
            top: 0 + e,
            width: r - 2 * e,
            height: a - 2 * e,
          });
        case S.TRAPE:
          return l({ left: 0 + (e = o[0] * Math.min(r / 2, a / 2)), top: 0 + e, width: r - 2 * e, height: a - e });
        case S.MOON:
          return l({
            left: 0 + (r * o[0]) / 3,
            top: 0 + (a * (1 - o[0])) / 2,
        ...
        case S.TRI:
          return l({ left: 0 + (r * o[0]) / 2, top: 0 + a / 2, width: r / 2, height: a / 2 });
        case S.CHEVRON:
          return l({ left: 0 + r * o[0], top: 0, width: r - 2 * r * o[0], height: a });
        case S.LEFT_ARW:
          var d,
            u = Ii.getAdjsPoint(t, 0, 0, r, a, 0),
            p = Ii.getAdjsPoint(t, 0, 0, r, a, 1),
            f = a - 2 * (p.y - 0);
          return (d = a <= 0 ? r : r - ((u.x - 0) * f) / a), l({ left: p.x - d, top: p.y, width: d, height: f });
        case S.RIGHT_ARW:
          return (
            (u = Ii.getAdjsPoint(t, 0, 0, r, a, 0)),
            (f = a - 2 * ((p = Ii.getAdjsPoint(t, 0, 0, r, a, 1)).y - 0)),
        ...
        case S.UP_ARW:
          return (
            (u = Ii.getAdjsPoint(t, 0, 0, r, a, 0)),
            (d = r - 2 * ((p = Ii.getAdjsPoint(t, 0, 0, r, a, 1)).x - 0)),
            (f = r <= 0 ? a : a - ((u.y - 0) * d) / r),
            l({
              left: p.x,
              top: p.y - f,
        ...
        case S.DOWN_ARW:
          return (
            (u = Ii.getAdjsPoint(t, 0, 0, r, a, 0)),
            l({
              left: (p = Ii.getAdjsPoint(t, 0, 0, r, a, 1)).x,
              top: p.y,
              width: r - 2 * (p.x - 0),
        ...
        case S.UP_ARW_COUT:
          return l({ left: 0, top: (e = Math.max(o[2], o[3])) * a, width: r, height: (1 - e) * a });
        case S.DOWN_ARW_COUT:
          return l({ left: 0, top: 0, width: r, height: a * (e = Math.min(o[2], o[3])) });
        case S.LEFT_ARW_COUT:
          var m = Math.max(o[2], o[0]);
          return l({ left: 0 + m * r, top: 0, width: r * (1 - m), height: a });
        case S.RIGHT_ARW_COUT:
          return l({ left: 0, top: 0, width: r * (m = Math.min(o[2], o[0])), height: a });
        case S.RIGHT_TRIANGLE:
          return l({ left: 0 + (1 * r) / 10, top: 0 + (6 * a) / 10, width: r / 2, height: (3 * a) / 10 });
        case S.DATA:
          return l({ left: 0 + 0.2 * r, top: 0, width: r - 0.4 * r, height: a });
        ...
        case S.PENTAGON:
          return l({ left: 0, top: 0, width: r - wt(o[0] * Math.min(r, a), 0, r), height: a });
        default:
          var g, v, y, _, T, w;
          if (h >= S.STAR_MIN && h <= S.STAR_MAX) {
            w = h - S.STAR_MIN;
            var b = Ii.getShapeStars(w);
            return (
              (T = a / (b.maxY - b.minY)),
              (_ = r / (b.maxX - b.minX)),
              (g = 0),
              ...
              5 === w
                ? l({
                    ...
                    width: Math.round(r - 2 * (r - (b.cXs[1] * y - b.minX) * _)),
                    height: Math.round((b.cYs[5] - b.cYs[1]) * y * T),
                  })
                : (4 === w || 6 === w || 8 === w
                    ? ((g = Math.round(r - (b.cXs[1] * y - b.minX) * _)), (v = Math.round((b.cYs[1] * y - b.minY) * T)))
                    : 12 === w
                    ? ((g = Math.round(r - (b.cXs[3] * y - b.minX) * _)), (v = Math.round((b.cYs[3] * y - b.minY) * T)))
                    : 24 === w &&
          ...
          if (h >= S.POLY_MIN && h <= S.POLY_MAX) {
            w = h - S.POLY_MIN;
            var E = Ii.getShapePolygon(w);
            if (((y = 0.8), (T = a / (E.maxY - E.minY)), (_ = r / (E.maxX - E.minX)), 5 === w))
              return l({
  ...
  var ki = _t(ei, {
    $init: function (t, e) {
      (this.autoplay = !1),
        t && (void 0 !== t.ap ? (this.autoplay = t.ap) : void 0 !== t.autoplay && (this.autoplay = t.autoplay)),
        ei.prototype.$init.call(this, t, e);
    },
    _onRemovedFromDoc: function () {
      if (this.sym) {
        var t = fe.docs.indexOf(this.sym);
        t > -1 && fe.docs.splice(t, 1), (t = fe.topDocs.indexOf(this.sym)) > -1 && fe.topDocs.splice(t, 1);
    ...
    setResource: function (t) {
      this.sym && (this.sym.destroy(), (this.sym = null)),
        t &&
          (this.sym = fe.openDoc(t, this.dom, {
            parentElement: this,
    ...
    _onResized: function (t, e) {
      this.sym && this.sym.layoutIfNeeded(), ei.prototype._onResized.call(this, t, e);
    },
    tick: function (t) {
  ...
  var Li = 'about:blank',
    Ni = _t(ei, {
      ...
      _setOverflow4Container: function (t) {
        (this.embeddedDom.scrolling = 'hidden' === t ? 'no' : 'scroll' === t ? 'yes' : 'auto'),
          this.srcdoc
            ? this.setSrcDoc(this.srcdoc)
            : this.embeddedDom.src && (this.embeddedDom.src = this.embeddedDom.src);
      },
      setUrl: function (t) {
        (t = t || Li),
          this.iframeUrl !== t && ((this.iframeUrl = t), (!st.srcdoc && this.srcdoc) || (this.embeddedDom.src = t));
      },
      setResource: function (t) {
        this.setUrl(t);
      },
      ...
      setSrcDoc: function (t) {
        if (((this.srcdoc = t || ''), st.srcdoc))
          t
            ...
            : (this.embeddedDom.removeAttribute('srcdoc'), nt && (this.embeddedDom.src = this.iframeUrl || Li));
        else if (t) {
          var e = function (i) {
            try {
          ...
          this.embeddedDom.addEventListener('load', e, !1), (this.embeddedDom.src = Li);
        } else this.embeddedDom.src = this.iframeUrl || Li;
      },
    });
  ii.regElemType(function (t, e) {
    return new Ni(t, e);
    ...
    ft(fe, {
      ...
      splitText: function (t, e) {
        ...
        if ((e = e || { words: !0 }).chars || e.words) {
          var n, o;
          if ((e.chars && (s.chars = []), e.words && (s.words = []), (s.processStyles = {}), e.processStyles)) {
            var r = e.processStyles.split(',');
            for (n = 0, o = r.length; n < o; ++n) s.processStyles[r[n].trim()] = [];
          }
          for (
            (function t(e, i, s) {
              if (e) {
      ...
      ElemType: t,
      messages: { _default: { unsupportedBrowser: "You're using a web browser we don't support." } },
    });
})(),
  /*!
  ...
  (function (t) {
    ...
    (i.init = function (t, e) {
      ...
      for (s = 0; s < a.length; ++s) this[(n = a[s])] = void 0 !== e[n] ? e[n] : h[s];
      (this.cRGB = this.getRGB(this.color)), this.draw(), r(this.cont, { display: 'none' });
    }),
      (i.cont = {}),
      (i.can = {}),
      (i.con = {}),
      ...
      (i.setColor = function (t) {
        (this.color = n.test(t) ? t : '#000000'), (this.cRGB = this.getRGB(this.color)), this.redraw();
      }),
      (i.getColor = function () {
        return this.color;
      }),
      ...
      (i.draw = function () {
        ...
        if (
          ...
          for (delete this._pendingDraw, m.clearRect(0, 0, 1e3, 1e3), a(this.cCan, { width: g, height: g }); u < p; ) {
            switch (
              ((d = u <= f ? 1 - (1 / f) * u : (d = 0)),
              (l = ((270 - (360 / p) * u) / 180) * Math.PI),
              (m.fillStyle = 'rgba(' + this.cRGB.r + ',' + this.cRGB.g + ',' + this.cRGB.b + ',' + d.toString() + ')'),
              this.shape)
            ) {
              case s[0]:
              case s[1]:
                ...
                (i = 0.27 * (e = 0.3 * g)),
                  ...
                  this.shape === s[3]
                    ...
                    : ((c = 0.55 * i),
                      ...
                      m.quadraticCurveTo(n + e, o - 0.5 * i, n + e, o - 0.5 * i + c),
                      m.lineTo(n + e, o - 0.5 * i + i - c),
                      m.quadraticCurveTo(n + e, o - 0.5 * i + i, n + e - c, o - 0.5 * i + i),
                      m.lineTo(n + c, o - 0.5 * i + i),
                      m.quadraticCurveTo(n, o - 0.5 * i + i, n, o - 0.5 * i + i - c),
          ...
          (this.con.textAlign = 'center'),
            ...
            (this.con.fillStyle = 'rgb(' + this.cRGB.r + ',' + this.cRGB.g + ',' + this.cRGB.b + ')'),
      ...
      (i.tick = function (t) {
        if ((t && delete this.prevTime, !(this.can.offsetWidth < 1 || this.can.offsetHeight < 1)))
          if (this._pendingDraw) this.draw();
            ...
            if ((s < 1 && (this.diameter = s = 1), this.prevTime)) {
              if (
                ((e = Math.floor(((n - this.prevTime) * this.speed) / 100)) === this.density && (e = this.density - 1),
                !e && !this.textChanged)
              )
                return;
            ...
            i.clearRect(0, 0, s, s),
              ...
              i.restore(),
              this.text && (i.fillText(this.text, s / 2, s / 2), (this.textChanged = !1));
          }
      }),
      (i.show = function () {
        if (!this.timer) {
      ...
      (i.kill = function () {
        this.hide(), this.cont.parentNode && this.cont.parentNode.removeChild(this.cont);
      }),
  ...
  (function (t, e) {
    ...
    function I(t, e, i) {
      var s = (function (t) {
        for (var e = t[0], i = t[1], s = i, n = e, o = 2; o < t.length; o += 6) {
          var r = t[o + 4],
            a = t[o + 5];
    ...
    function N(t, e) {
      ...
      for (var o = 1, r = 1; r < e - 1; ) {
        (n[++r] = t[++o]), (n[++r] = t[++o]), (n[++r] = t[++o]), (n[++r] = t[++o]);
        var a = (n[++r] = t[++o]),
          h = (n[++r] = t[++o]);
        if (i)
          for (var l = 0; l < s && i; l++)
            (n[r + 5] = n[r + 3] = n[r + 1] = a), (n[r + 6] = n[r + 4] = n[r + 2] = h), (r += 6), (i -= 6);
      }
      return n;
    }
        ...
        .map(function (t) {
          return {
            ...
            perimeter: (function (t) {
              for (var e = t.length, i = t[e - 2], s = t[e - 1], n = 0, o = 0; o < e; o += 6)
          ...
          (i.optimize === s
            ? (function t(e, i, s) {
                ...
                for (var r = o; r < n; r++) {
                  ...
                  for (var d = O(a.length), u = 0; u < a.length; u += 2) (d[u] = h), (d[u + 1] = l);
                  i[r] = d;
                }
              })(t, e, i.origin)
            : M('optimize:none requires equal lengths'));
      var n = Array(2);
      if (((n[0] = t), (n[1] = e), i.optimize === s)) {
        for (var o = i.origin, r = o.x, a = o.y, h = o.absolute, l = 0; l < t.length; l++)
    ...
    function W(t, s) {
      (s = (function (t, e) {
        ...
        (!t || t.length < 2) && M('invalid arguments');
      for (var n = t.length - 1, o = Array(n), r = 0; r < n; r++) o[r] = V(t[r], t[r + 1], s);
      var a = s.precision
        ? function (t) {
          ...
          for (var s = [], n = 0; n < t.length; n++) {
            ...
            for (var r = void 0, a = 2; a < o.length; a += 6) {
              var c = e(o[a]),
                ...
                f = e(o[a + 4]),
                m = e(o[a + 5]);
              (c == f && u == f && d == m && p == m && r == (r = '' + c + d + u + p + f + m)) ||
                s.push(c, d, u, p, f, m);
            }
          }
          return s.join(i);
    ...
    function V(t, e, i) {
      var s = B(t.getData(), e.getData(), i),
        n = s[0].length;
      return function (i) {
        if (m(i - 0) < C) return t.getStringData();
        if (m(i - 1) < C) return e.getStringData();
        for (var o = Array(n), r = 0; r < n; r++) o[r] = Y(s[0][r], s[1][r], i);
        return o;
      };
    }

    function Y(t, e, i) {
      for (var s = g(t.length, e.length), n = O(s), o = 0; o < s; o++) n[o] = t[o] + (e[o] - t[o]) * i;
      return n;
    }
    ...
    function z(t, e, i, s, n, o, r, a, h, l, c, d, u) {
      ...
      if (!y) {
        var _ = t,
          w = a,
          A = ((t = _ * g - e * -v) - (a = w * g - h * -v)) / 2,
          C = ((e = _ * -v + e * g) - (h = w * -v + h * g)) / 2,
          M = (A * A) / (i * i) + (C * C) / (s * s);
        M > 1 && ((i *= M = T(M)), (s *= M));
        var P =
          (o === r ? -1 : 1) * T(m((i * i * s * s - i * i * C * C - s * s * A * A) / (i * i * C * C + s * s * A * A)));
        (d = (P * i * C) / s + (t + a) / 2),
          (l = b((e - (u = (P * -s * A) / i + (e + h) / 2)) / s)),
          (c = b((h - u) / s)),
          t < d && (l = x - l),
          a < d && (c = x - c),
          l < 0 && (l += X),
      ...
      if (
        ...
        for (var L = 0, N = p.length; L < N; L += 2) {
          var F = p[L],
            B = p[L + 1];
          (p[L] = F * g - B * v), (p[L + 1] = F * v + B * g);
        }
      return p;
    }
    ...
    function q(t, e, i, s, n, o, r) {
      ...
      (t.x = G(o, a)),
        (t.y = G(r, h)),
        t.current.push(G(e, a), (i = G(i, h)), (s = G(s, a)), (n = G(n, h)), t.x, t.y),
        (t.lc = t.c);
    }
    ...
    function J(t) {
      for (
        var i = {
          ...
          s = t
            .replace(/[\^\s]*([mhvlzcsqta]|[+-]?\d*\.?\d+(?:[Ee][+-]?\d+)?)[,\$\s]*/gi, ' $1')
        ...
        do {
          ...
          var S = i.t,
            ...
            R = void 0,
            O = void 0;
          if (v === h) i.segments.push((i.current = [(i.x = S[0]), (i.y = S[1])]));
          ...
          else if (v === l) q(i, S[0], S[1], S[2], S[3], S[4], S[5]), (i.cx = S[2]), (i.cy = S[3]);
          else if (v === c) {
            var I = i.lc !== c && i.lc !== l;
            q(i, (D = I ? e : 2 * b - i.cx), (x = I ? e : 2 * E - i.cy), S[0], S[1], S[2], S[3]),
              (i.cx = S[0]),
              (i.cy = S[1]);
          } else if (v === d) {
            var k = S[0],
            ...
            (C = S[2]),
              (P = S[3]),
              q(i, b + (k - b) * A, E + (L - E) * A, C + (k - C) * A, P + (L - P) * A, C, P),
              (i.cx = k),
              (i.cy = L);
          } else if (v === u)
            (C = S[0]),
            ...
            for (var N = z(b, E, S[0], S[1], S[2], S[3], S[4], S[5], S[6]), F = 0; F < N.length; F += 6)
              q(i, N[F], N[F + 1], N[F + 2], N[F + 3], N[F + 4], N[F + 5]);
          else M(i.c, ' is not supported');
          w += _;
        } while (w < T.length);
      }
      return i.segments;
    ...
    var tt = (function () {
      function t(t) {
        var i = (function (t) {
            ...
            var i;
            if (('string' == typeof t && K.test(t) ? (t = document.querySelector(t)) : (i = t), 'string' == typeof t))
              return {
                data: J(t),
                stringData: i,
              };
            ...
            return 'PATH' === s.tagName.toUpperCase()
              ? {
                  data: J((i = s.getAttribute('d'))),
                  stringData: i,
                }
              : M('Unsupported element ', s.tagName);
          })(t),
          s = i.data,
          n = i.stringData;
